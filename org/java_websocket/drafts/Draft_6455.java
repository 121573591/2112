...
extends Draft {
    ...
    public Draft_6455(IExtension inputExtension) {
        this((List<IExtension>)Collections.singletonList((Object)inputExtension));
    }

    public Draft_6455(List<IExtension> inputExtensions) {
        this(inputExtensions, (List<IProtocol>)Collections.singletonList((Object)new Protocol("")));
    }
    ...
    public Draft_6455(List<IExtension> inputExtensions, int inputMaxFrameSize) {
        this(inputExtensions, (List<IProtocol>)Collections.singletonList((Object)new Protocol("")), inputMaxFrameSize);
    }
    ...
    public Draft_6455(List<IExtension> inputExtensions, List<IProtocol> inputProtocols, int inputMaxFrameSize) {
        ...
        if (!hasDefault) {
            this.knownExtensions.add(this.knownExtensions.size(), (Object)this.negotiatedExtension);
        }
    ...
    public HandshakeState acceptHandshakeAsClient(ClientHandshake request, ServerHandshake response) throws InvalidHandshakeException {
        ...
        if (!(seckeyChallenge = this.generateFinalKey(seckeyChallenge)).equals((Object)seckeyAnswer)) {
    ...
    public HandshakeBuilder postProcessHandshakeResponseAsServer(ClientHandshake request, ServerHandshakeBuilder response) throws InvalidHandshakeException {
        ...
        if (seckey == null || "".equals((Object)seckey)) {
    ...
    public Draft copyInstance() {
        ...
        for (IExtension knownExtension : this.getKnownExtensions()) {
            newExtensions.add((Object)knownExtension.copyInstance());
        }
        ArrayList newProtocols = new ArrayList();
        for (IProtocol knownProtocol : this.getKnownProtocols()) {
            newProtocols.add((Object)knownProtocol.copyInstance());
        }
        return new Draft_6455((List<IExtension>)newExtensions, (List<IProtocol>)newProtocols, this.maxFrameSize);
    }
    ...
    private ByteBuffer createByteBufferFromFramedata(Framedata framedata) {
        ...
        ByteBuffer buf = ByteBuffer.allocate((int)(1 + (sizebytes > 1 ? sizebytes + 1 : sizebytes) + (mask ? 4 : 0) + mes.remaining()));
        ...
        if (mask) {
            ByteBuffer maskkey = ByteBuffer.allocate((int)4);
    ...
    private Framedata translateSingleFrame(ByteBuffer buffer) throws IncompleteException, InvalidDataException {
        ...
        ByteBuffer payload = ByteBuffer.allocate((int)this.checkAlloc(payloadlength));
        if (mask) {
    ...
    public List<Framedata> translateFrame(ByteBuffer buffer) throws InvalidDataException {
        ...
        while (true) {
            ...
            try {
                ...
                frames.add((Object)cur);
                this.incompleteframe = null;
            }
            catch (IncompleteException e) {
                ByteBuffer extendedframe = ByteBuffer.allocate((int)this.checkAlloc(e.getPreferredSize()));
        ...
        while (buffer.hasRemaining()) {
            ...
            try {
                ...
                this.incompleteframe = ByteBuffer.allocate((int)this.checkAlloc(pref));
    ...
    public List<Framedata> createFrames(ByteBuffer binary, boolean mask) {
        ...
        try {
            ...
            throw new NotSendableException((Throwable)((Object)e));
        }
        return Collections.singletonList((Object)curframe);
    }

    @Override
    public List<Framedata> createFrames(String text, boolean mask) {
        TextFrame curframe = new TextFrame();
        curframe.setPayload(ByteBuffer.wrap((byte[])Charsetfunctions.utf8Bytes(text)));
        curframe.setTransferemasked(mask);
        try {
            curframe.isValid();
        }
    ...
    private String getServerTime() {
        ...
        dateFormat.setTimeZone(TimeZone.getTimeZone((String)"GMT"));
    ...
    private String generateFinalKey(String in) {
        ...
        try {
            sh1 = MessageDigest.getInstance((String)"SHA1");
        }
    ...
    private void logRuntimeException(WebSocketImpl webSocketImpl, RuntimeException e) {
        ...
        webSocketImpl.getWebSocketListener().onWebsocketError(webSocketImpl, (Exception)((Object)e));
    }
    ...
    private void addToBufferList(ByteBuffer payloadData) {
        List<ByteBuffer> list = this.byteBufferList;
        synchronized (list) {
            this.byteBufferList.add((Object)payloadData);
        }
    }
    ...
    private ByteBuffer getPayloadFromByteBufferList() throws LimitExceededException {
        ...
        synchronized (list) {
            ...
            this.checkBufferLimit();
            resultingByteBuffer = ByteBuffer.allocate((int)((int)totalSize));
            for (ByteBuffer buffer : this.byteBufferList) {

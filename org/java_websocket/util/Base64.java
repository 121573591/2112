...
public class Base64 {
    ...
    private static byte[] encode3to4(byte[] source2, int srcOffset, int numSigBytes, byte[] destination, int destOffset, int options) {
    ...
    public static String encodeBytes(byte[] source2) {
        ...
        block3: {
            encoded = null;
            try {
                encoded = Base64.encodeBytes(source2, 0, source2.length, 0);
            }
    ...
    public static String encodeBytes(byte[] source2, int off, int len, int options) throws IOException {
        byte[] encoded = Base64.encodeBytesToBytes(source2, off, len, options);
        try {
    ...
    public static byte[] encodeBytesToBytes(byte[] source2, int off, int len, int options) throws IOException {
        if (source2 == null) {
        ...
        if (off + len > source2.length) {
            throw new IllegalArgumentException(String.format((String)"Cannot have offset of %d and length of %d with array of length %d", (Object[])new Object[]{off, len, source2.length}));
        }
        if ((options & 2) != 0) {
        ...
        int lineLength = 0;
        while (d < len2) {
            Base64.encode3to4(source2, d + off, 3, outBuff, e, options);
        ...
        if (d < len) {
            Base64.encode3to4(source2, d + off, len - d, outBuff, e, options);
            e += 4;
        }
        if (e <= outBuff.length - 1) {
            byte[] finalOut = new byte[e];
            System.arraycopy((Object)outBuff, (int)0, (Object)finalOut, (int)0, (int)e);
            return finalOut;
        }
        return outBuff;
    }

    private static int decode4to3(byte[] source2, int srcOffset, byte[] destination, int destOffset, int options) {
        if (source2 == null) {
        ...
        if (srcOffset < 0 || srcOffset + 3 >= source2.length) {
            throw new IllegalArgumentException(String.format((String)"Source array with length %d cannot have offset of %d and still process four bytes.", (Object[])new Object[]{source2.length, srcOffset}));
        }
        if (destOffset < 0 || destOffset + 2 >= destination.length) {
            throw new IllegalArgumentException(String.format((String)"Destination array with length %d cannot have offset of %d and still store three bytes.", (Object[])new Object[]{destination.length, destOffset}));
        }

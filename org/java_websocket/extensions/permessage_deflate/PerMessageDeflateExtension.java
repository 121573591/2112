...
extends CompressionExtension {
    ...
    public void decodeFrame(Framedata inputFrame) throws InvalidDataException {
        ...
        ((FramedataImpl1)inputFrame).setPayload(ByteBuffer.wrap((byte[])output.toByteArray(), (int)0, (int)output.size()));
    }
    ...
    public void encodeFrame(Framedata inputFrame) {
        ...
        ((FramedataImpl1)inputFrame).setPayload(ByteBuffer.wrap((byte[])outputBytes, (int)0, (int)outputLength));
    }
    ...
    public boolean acceptProvidedExtensionAsServer(String inputExtension) {
        ...
        for (String extension : requestedExtensions = inputExtension.split(",")) {
            ...
            if (this.requestedParameters.containsKey((Object)CLIENT_NO_CONTEXT_TAKEOVER)) {
    ...
    public String getProvidedExtensionAsClient() {
        this.requestedParameters.put((Object)CLIENT_NO_CONTEXT_TAKEOVER, (Object)"");
        this.requestedParameters.put((Object)SERVER_NO_CONTEXT_TAKEOVER, (Object)"");

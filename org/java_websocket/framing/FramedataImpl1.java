...
implements Framedata {
    ...
    public void append(Framedata nextframe) {
        ...
        if (this.unmaskedpayload == null) {
            this.unmaskedpayload = ByteBuffer.allocate((int)b.remaining());
            b.mark();
            ...
            if (b.remaining() > this.unmaskedpayload.remaining()) {
                ByteBuffer tmp = ByteBuffer.allocate((int)(b.remaining() + this.unmaskedpayload.capacity()));
    ...
    public boolean equals(Object o) {
        ...
        return this.unmaskedpayload != null ? this.unmaskedpayload.equals((Object)that.unmaskedpayload) : that.unmaskedpayload == null;
    }

...
extends Scope {
    ...
    private ScriptContext currentContext() {
        ScriptContext sc;
        ScriptContext scriptContext = sc = this.scontext != null ? (ScriptContext)this.scontext.get() : null;
        if (sc != null) {
            return sc;
        }
    ...
    private static PropertyMap checkAndGetMap(Context context) {
        ...
        if (sm != null) {
            sm.checkPermission((Permission)new RuntimePermission("nashorn.createGlobal"));
        }
    ...
    public static Global instance() {
        return (Global)Objects.requireNonNull((Object)Context.getGlobal());
    }
    ...
    public PropertyDescriptor newAccessorDescriptor(Object get2, Object set, boolean configurable, boolean enumerable) {
        AccessorPropertyDescriptor desc = new AccessorPropertyDescriptor(configurable, enumerable, get2 == null ? ScriptRuntime.UNDEFINED : get2, set == null ? ScriptRuntime.UNDEFINED : set, this);
        if (get2 == null) {
    ...
    private <T> T getLazilyCreatedValue(Object key, Supplier<T> creator, Map<Object, T> map) {
        ...
        try {
            ...
            Object object = (existingObj = map.putIfAbsent(key, newObj = creator.get())) != null ? existingObj : newObj;
            return (T)object;
        }
        finally {
            if (differentGlobal) {
    ...
    public static Object __noSuchProperty__(Object self, Object name) {
        ...
        if ("context".equals((Object)nameStr)) {
            return sctxt;
        }
        if ("engine".equals((Object)nameStr) && (System.getSecurityManager() == null || global.getClassFilter() == null)) {
    ...
    public static Object load(Object self, Object source2) throws IOException {
        Global global = Global.instanceFrom(self);
        return global.getContext().load(self, source2);
    }
    ...
    public static Object loadWithNewGlobal(Object self, Object ... args) throws IOException {
        ...
        Object[] arguments = hasArgs ? Arrays.copyOfRange((Object[])args, (int)1, (int)length) : args;
        return global.getContext().loadWithNewGlobal(from, arguments);
    }

    public static Object exit(Object self, Object code) {
        System.exit((int)JSType.toInt32(code));
        return ScriptRuntime.UNDEFINED;
    }
    ...
    public static boolean isBuiltInJavaExtend(ScriptFunction fn) {
        if (!"extend".equals((Object)fn.getName())) {
            return false;
        }
    ...
    public static boolean isBuiltInJavaTo(ScriptFunction fn) {
        if (!"to".equals((Object)fn.getName())) {
            return false;
        }
    ...
    @Override
    public void addBoundProperties(ScriptObject source2, Property[] properties) {
        ...
        for (Property property : properties) {
            if (property.isLexicalBinding()) {
                ...
                lexicalMap = lexScope.addBoundProperty(lexicalMap, source2, property, true);
                if (ownMap.findProperty(property.getKey()) == null) continue;
                this.invalidateGlobalConstant(property.getKey());
                continue;
            }
            ownMap = this.addBoundProperty(ownMap, source2, property, extensible);
        }
        this.setMap(ownMap);
    ...
    private synchronized void invalidateLexicalSwitchPoint() {
        if (this.lexicalScopeSwitchPoint != null) {
            ...
            SwitchPoint.invalidateAll((SwitchPoint[])new SwitchPoint[]{this.lexicalScopeSwitchPoint});
        }
    }
    ...
    private void init(ScriptEngine eng) {
        ...
        if (Context.DEBUG) {
            ...
            if (sm != null) {
                try {
                    sm.checkPermission((Permission)new RuntimePermission("nashorn.debugMode"));
                    debugOkay = true;
                }
    ...
    private void initScripting(ScriptEnvironment scriptEnv) {
        ...
        if (System.getSecurityManager() == null) {
            ...
            env.put("PWD", System.getProperty((String)"user.dir"), scriptEnv._strict);
        }
    ...
    private static void copyOptions(ScriptObject options, ScriptEnvironment scriptEnv) {
        for (Field f : scriptEnv.getClass().getFields()) {
            try {
                options.set((Object)f.getName(), f.get((Object)scriptEnv), 0);
            }
    ...
    private <T extends ScriptObject> T initConstructor(String name, Class<T> clazz) {
        try {
            ...
            Class funcClass = Class.forName((String)sb.toString());
    ...
    private ScriptObject initPrototype(String name, ScriptObject prototype) {
        try {
            ...
            Class funcClass = Class.forName((String)className);
    ...
    private List<Property> extractBuiltinProperties(String name, ScriptObject func) {
        ...
        list.addAll((Collection)Arrays.asList((Object[])func.getMap().getProperties()));
        if (func instanceof ScriptFunction && (proto = ScriptFunction.getPrototype((ScriptFunction)func)) != null) {
            list.addAll((Collection)Arrays.asList((Object[])proto.getMap().getProperties()));
        }
        if ((prop = this.getProperty(name)) != null) {
            list.add((Object)prop);
        }
        return list;
    }
    ...
    private void initFunctionAndObject() {
        ...
        for (Property property : properties = this.getObjectPrototype().getMap().getProperties()) {
            key = property.getKey();
            if (key.equals((Object)"constructor") || !((value = ObjectPrototype.get(key)) instanceof ScriptFunction) || (prototype = ScriptFunction.getPrototype(func = (ScriptFunction)value)) == null) continue;
            prototype.setInitialProto(ObjectPrototype);
        }
    ...
    public static void $clinit$() {
        ...
        arrayList.add((Object)AccessorProperty.create("arguments", 6, cfr_ldc_0(), cfr_ldc_1()));
        arrayList.add((Object)AccessorProperty.create("parseInt", 2, cfr_ldc_2(), cfr_ldc_3()));
        arrayList.add((Object)AccessorProperty.create("parseFloat", 2, cfr_ldc_4(), cfr_ldc_5()));
        arrayList.add((Object)AccessorProperty.create("isNaN", 2, cfr_ldc_6(), cfr_ldc_7()));
        arrayList.add((Object)AccessorProperty.create("isFinite", 2, cfr_ldc_8(), cfr_ldc_9()));
        arrayList.add((Object)AccessorProperty.create("encodeURI", 2, cfr_ldc_10(), cfr_ldc_11()));
        arrayList.add((Object)AccessorProperty.create("encodeURIComponent", 2, cfr_ldc_12(), cfr_ldc_13()));
        arrayList.add((Object)AccessorProperty.create("decodeURI", 2, cfr_ldc_14(), cfr_ldc_15()));
        arrayList.add((Object)AccessorProperty.create("decodeURIComponent", 2, cfr_ldc_16(), cfr_ldc_17()));
        arrayList.add((Object)AccessorProperty.create("escape", 2, cfr_ldc_18(), cfr_ldc_19()));
        arrayList.add((Object)AccessorProperty.create("unescape", 2, cfr_ldc_20(), cfr_ldc_21()));
        arrayList.add((Object)AccessorProperty.create("print", 2, cfr_ldc_22(), cfr_ldc_23()));
        arrayList.add((Object)AccessorProperty.create("load", 2, cfr_ldc_24(), cfr_ldc_25()));
        arrayList.add((Object)AccessorProperty.create("loadWithNewGlobal", 2, cfr_ldc_26(), cfr_ldc_27()));
        arrayList.add((Object)AccessorProperty.create("exit", 2, cfr_ldc_28(), cfr_ldc_29()));
        arrayList.add((Object)AccessorProperty.create("quit", 2, cfr_ldc_30(), cfr_ldc_31()));
        arrayList.add((Object)AccessorProperty.create("NaN", 7, cfr_ldc_32(), null));
        arrayList.add((Object)AccessorProperty.create("Infinity", 7, cfr_ldc_33(), null));
        arrayList.add((Object)AccessorProperty.create("undefined", 7, cfr_ldc_34(), null));
        arrayList.add((Object)AccessorProperty.create("eval", 2, cfr_ldc_35(), cfr_ldc_36()));
        arrayList.add((Object)AccessorProperty.create("Object", 2, cfr_ldc_37(), cfr_ldc_38()));
        arrayList.add((Object)AccessorProperty.create("Function", 2, cfr_ldc_39(), cfr_ldc_40()));
        arrayList.add((Object)AccessorProperty.create("Array", 2, cfr_ldc_41(), cfr_ldc_42()));
        arrayList.add((Object)AccessorProperty.create("String", 2, cfr_ldc_43(), cfr_ldc_44()));
        arrayList.add((Object)AccessorProperty.create("Boolean", 2, cfr_ldc_45(), cfr_ldc_46()));
        arrayList.add((Object)AccessorProperty.create("Number", 2, cfr_ldc_47(), cfr_ldc_48()));
        arrayList.add((Object)AccessorProperty.create("Math", 2, cfr_ldc_49(), cfr_ldc_50()));
        arrayList.add((Object)AccessorProperty.create("Error", 2, cfr_ldc_51(), cfr_ldc_52()));
        arrayList.add((Object)AccessorProperty.create("ReferenceError", 2, cfr_ldc_53(), cfr_ldc_54()));
        arrayList.add((Object)AccessorProperty.create("SyntaxError", 2, cfr_ldc_55(), cfr_ldc_56()));
        arrayList.add((Object)AccessorProperty.create("TypeError", 2, cfr_ldc_57(), cfr_ldc_58()));
        arrayList.add((Object)AccessorProperty.create("Packages", 2, cfr_ldc_59(), cfr_ldc_60()));
        arrayList.add((Object)AccessorProperty.create("com", 2, cfr_ldc_61(), cfr_ldc_62()));
        arrayList.add((Object)AccessorProperty.create("edu", 2, cfr_ldc_63(), cfr_ldc_64()));
        arrayList.add((Object)AccessorProperty.create("java", 2, cfr_ldc_65(), cfr_ldc_66()));
        arrayList.add((Object)AccessorProperty.create("javafx", 2, cfr_ldc_67(), cfr_ldc_68()));
        arrayList.add((Object)AccessorProperty.create("javax", 2, cfr_ldc_69(), cfr_ldc_70()));
        arrayList.add((Object)AccessorProperty.create("org", 2, cfr_ldc_71(), cfr_ldc_72()));
        arrayList.add((Object)AccessorProperty.create("__FILE__", 7, cfr_ldc_73(), null));
        arrayList.add((Object)AccessorProperty.create("__DIR__", 7, cfr_ldc_74(), null));
        arrayList.add((Object)AccessorProperty.create("__LINE__", 7, cfr_ldc_75(), null));
        arrayList.add((Object)AccessorProperty.create("Date", 2, cfr_ldc_76(), cfr_ldc_77()));
        arrayList.add((Object)AccessorProperty.create("RegExp", 2, cfr_ldc_78(), cfr_ldc_79()));
        arrayList.add((Object)AccessorProperty.create("JSON", 2, cfr_ldc_80(), cfr_ldc_81()));
        arrayList.add((Object)AccessorProperty.create("JSAdapter", 2, cfr_ldc_82(), cfr_ldc_83()));
        arrayList.add((Object)AccessorProperty.create("EvalError", 2, cfr_ldc_84(), cfr_ldc_85()));
        arrayList.add((Object)AccessorProperty.create("RangeError", 2, cfr_ldc_86(), cfr_ldc_87()));
        arrayList.add((Object)AccessorProperty.create("URIError", 2, cfr_ldc_88(), cfr_ldc_89()));
        arrayList.add((Object)AccessorProperty.create("ArrayBuffer", 2, cfr_ldc_90(), cfr_ldc_91()));
        arrayList.add((Object)AccessorProperty.create("DataView", 2, cfr_ldc_92(), cfr_ldc_93()));
        arrayList.add((Object)AccessorProperty.create("Int8Array", 2, cfr_ldc_94(), cfr_ldc_95()));
        arrayList.add((Object)AccessorProperty.create("Uint8Array", 2, cfr_ldc_96(), cfr_ldc_97()));
        arrayList.add((Object)AccessorProperty.create("Uint8ClampedArray", 2, cfr_ldc_98(), cfr_ldc_99()));
        arrayList.add((Object)AccessorProperty.create("Int16Array", 2, cfr_ldc_100(), cfr_ldc_101()));
        arrayList.add((Object)AccessorProperty.create("Uint16Array", 2, cfr_ldc_102(), cfr_ldc_103()));
        arrayList.add((Object)AccessorProperty.create("Int32Array", 2, cfr_ldc_104(), cfr_ldc_105()));
        arrayList.add((Object)AccessorProperty.create("Uint32Array", 2, cfr_ldc_106(), cfr_ldc_107()));
        arrayList.add((Object)AccessorProperty.create("Float32Array", 2, cfr_ldc_108(), cfr_ldc_109()));
        arrayList.add((Object)AccessorProperty.create("Float64Array", 2, cfr_ldc_110(), cfr_ldc_111()));
        arrayList.add((Object)AccessorProperty.create("Symbol", 2, cfr_ldc_112(), cfr_ldc_113()));
        arrayList.add((Object)AccessorProperty.create("Map", 2, cfr_ldc_114(), cfr_ldc_115()));
        arrayList.add((Object)AccessorProperty.create("WeakMap", 2, cfr_ldc_116(), cfr_ldc_117()));
        arrayList.add((Object)AccessorProperty.create("Set", 2, cfr_ldc_118(), cfr_ldc_119()));
        arrayList.add((Object)AccessorProperty.create("WeakSet", 2, cfr_ldc_120(), cfr_ldc_121()));
        arrayList.add((Object)AccessorProperty.create("JavaImporter", 2, cfr_ldc_122(), cfr_ldc_123()));
        arrayList.add((Object)AccessorProperty.create("Java", 2, cfr_ldc_124(), cfr_ldc_125()));
    ...
    extends ScriptObject {
        ...
        @Override
        protected PropertyMap addBoundProperty(PropertyMap propMap, ScriptObject source2, Property property, boolean extensible) {
            return super.addBoundProperty(propMap, source2, property, extensible);
        }
        ...
        private static GuardedInvocation filterInvocation(GuardedInvocation invocation) {
            ...
            return invocation.asType(type.changeParameterType(0, Object.class)).filterArguments(0, new MethodHandle[]{LEXICAL_SCOPE_FILTER});
        }
    }
}

...
extends ScriptFunction {
    ...
    static {
        ...
        arrayList.add((Object)AccessorProperty.create("setIndexedPropertiesToExternalArrayData", 2, cfr_ldc_0(), cfr_ldc_1()));
        arrayList.add((Object)AccessorProperty.create("getPrototypeOf", 2, cfr_ldc_2(), cfr_ldc_3()));
        arrayList.add((Object)AccessorProperty.create("setPrototypeOf", 2, cfr_ldc_4(), cfr_ldc_5()));
        arrayList.add((Object)AccessorProperty.create("getOwnPropertyDescriptor", 2, cfr_ldc_6(), cfr_ldc_7()));
        arrayList.add((Object)AccessorProperty.create("getOwnPropertyNames", 2, cfr_ldc_8(), cfr_ldc_9()));
        arrayList.add((Object)AccessorProperty.create("getOwnPropertySymbols", 2, cfr_ldc_10(), cfr_ldc_11()));
        arrayList.add((Object)AccessorProperty.create("create", 2, cfr_ldc_12(), cfr_ldc_13()));
        arrayList.add((Object)AccessorProperty.create("defineProperty", 2, cfr_ldc_14(), cfr_ldc_15()));
        arrayList.add((Object)AccessorProperty.create("defineProperties", 2, cfr_ldc_16(), cfr_ldc_17()));
        arrayList.add((Object)AccessorProperty.create("seal", 2, cfr_ldc_18(), cfr_ldc_19()));
        arrayList.add((Object)AccessorProperty.create("freeze", 2, cfr_ldc_20(), cfr_ldc_21()));
        arrayList.add((Object)AccessorProperty.create("preventExtensions", 2, cfr_ldc_22(), cfr_ldc_23()));
        arrayList.add((Object)AccessorProperty.create("isSealed", 2, cfr_ldc_24(), cfr_ldc_25()));
        arrayList.add((Object)AccessorProperty.create("isFrozen", 2, cfr_ldc_26(), cfr_ldc_27()));
        arrayList.add((Object)AccessorProperty.create("isExtensible", 2, cfr_ldc_28(), cfr_ldc_29()));
        arrayList.add((Object)AccessorProperty.create("keys", 2, cfr_ldc_30(), cfr_ldc_31()));
        arrayList.add((Object)AccessorProperty.create("bindProperties", 2, cfr_ldc_32(), cfr_ldc_33()));

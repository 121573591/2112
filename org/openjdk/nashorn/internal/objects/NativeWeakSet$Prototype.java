...
extends PrototypeObject {
    ...
    static {
        ...
        arrayList.add((Object)AccessorProperty.create("add", 2, cfr_ldc_0(), cfr_ldc_1()));
        arrayList.add((Object)AccessorProperty.create("has", 2, cfr_ldc_2(), cfr_ldc_3()));
        arrayList.add((Object)AccessorProperty.create("delete", 2, cfr_ldc_4(), cfr_ldc_5()));

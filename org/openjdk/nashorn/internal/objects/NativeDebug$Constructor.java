...
extends ScriptObject {
    ...
    static {
        ...
        arrayList.add((Object)AccessorProperty.create("getArrayDataClass", 2, cfr_ldc_0(), cfr_ldc_1()));
        arrayList.add((Object)AccessorProperty.create("getArrayData", 2, cfr_ldc_2(), cfr_ldc_3()));
        arrayList.add((Object)AccessorProperty.create("getContext", 2, cfr_ldc_4(), cfr_ldc_5()));
        arrayList.add((Object)AccessorProperty.create("map", 2, cfr_ldc_6(), cfr_ldc_7()));
        arrayList.add((Object)AccessorProperty.create("identical", 2, cfr_ldc_8(), cfr_ldc_9()));
        arrayList.add((Object)AccessorProperty.create("equalWithoutType", 2, cfr_ldc_10(), cfr_ldc_11()));
        arrayList.add((Object)AccessorProperty.create("diffPropertyMaps", 2, cfr_ldc_12(), cfr_ldc_13()));
        arrayList.add((Object)AccessorProperty.create("getClass", 2, cfr_ldc_14(), cfr_ldc_15()));
        arrayList.add((Object)AccessorProperty.create("equals", 2, cfr_ldc_16(), cfr_ldc_17()));
        arrayList.add((Object)AccessorProperty.create("toJavaString", 2, cfr_ldc_18(), cfr_ldc_19()));
        arrayList.add((Object)AccessorProperty.create("toIdentString", 2, cfr_ldc_20(), cfr_ldc_21()));
        arrayList.add((Object)AccessorProperty.create("isDebuggableFunction", 2, cfr_ldc_22(), cfr_ldc_23()));
        arrayList.add((Object)AccessorProperty.create("getListenerCount", 2, cfr_ldc_24(), cfr_ldc_25()));
        arrayList.add((Object)AccessorProperty.create("dumpCounters", 2, cfr_ldc_26(), cfr_ldc_27()));
        arrayList.add((Object)AccessorProperty.create("getEventQueueCapacity", 2, cfr_ldc_28(), cfr_ldc_29()));
        arrayList.add((Object)AccessorProperty.create("setEventQueueCapacity", 2, cfr_ldc_30(), cfr_ldc_31()));
        arrayList.add((Object)AccessorProperty.create("addRuntimeEvent", 2, cfr_ldc_32(), cfr_ldc_33()));
        arrayList.add((Object)AccessorProperty.create("expandEventQueueCapacity", 2, cfr_ldc_34(), cfr_ldc_35()));
        arrayList.add((Object)AccessorProperty.create("clearRuntimeEvents", 2, cfr_ldc_36(), cfr_ldc_37()));
        arrayList.add((Object)AccessorProperty.create("removeRuntimeEvent", 2, cfr_ldc_38(), cfr_ldc_39()));
        arrayList.add((Object)AccessorProperty.create("getRuntimeEvents", 2, cfr_ldc_40(), cfr_ldc_41()));
        arrayList.add((Object)AccessorProperty.create("getLastRuntimeEvent", 2, cfr_ldc_42(), cfr_ldc_43()));

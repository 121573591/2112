...
public final class NativeFunction {
    public static final MethodHandle TO_APPLY_ARGS = Lookup.findOwnStatic((MethodHandles.Lookup)MethodHandles.lookup(), (String)"toApplyArgs", Object[].class, (Class[])new Class[]{Object.class});
    ...
    public static Object[] toApplyArgs(Object array) {
        ...
        if (array instanceof JSObject) {
            ...
            Object len = jsObj.hasMember("length") ? jsObj.getMember("length") : Integer.valueOf((int)0);
    ...
    public static Object call(Object self, Object ... args) {
        ...
        if (args.length > 1) {
            ...
            System.arraycopy((Object)args, (int)1, (Object)arguments, (int)0, (int)arguments.length);
        } else {

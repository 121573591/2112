...
extends ScriptObject {
    ...
    public Iterator<String> propertyIterator() {
        ...
        while (iter.hasNext()) {
            array.add((Object)((String)iter.next()));
        }
    ...
    private GuardedInvocation findHook(CallSiteDescriptor desc, String hook, boolean useName) {
        ...
        if (__call__.equals((Object)hook)) {
            throw ECMAErrors.typeError("no.such.function", NashornCallSiteDescriptor.getOperand(desc), ScriptRuntime.safeToString(this));
        }
        MethodHandle methodHandle = hook.equals((Object)__put__) ? Lookup.MH.asType(Lookup.EMPTY_SETTER, type) : Lookup.emptyGetter(type.returnType());

...
extends PrototypeObject {
    ...
    static {
        ...
        arrayList.add((Object)AccessorProperty.create("name", 2, cfr_ldc_0(), cfr_ldc_1()));
        arrayList.add((Object)AccessorProperty.create("message", 2, cfr_ldc_2(), cfr_ldc_3()));
        arrayList.add((Object)AccessorProperty.create("printStackTrace", 2, cfr_ldc_4(), cfr_ldc_5()));
        arrayList.add((Object)AccessorProperty.create("getStackTrace", 2, cfr_ldc_6(), cfr_ldc_7()));
        arrayList.add((Object)AccessorProperty.create("toString", 2, cfr_ldc_8(), cfr_ldc_9()));

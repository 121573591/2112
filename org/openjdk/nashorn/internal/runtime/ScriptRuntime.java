...
public final class ScriptRuntime {
    ...
    public static Iterator<?> toPropertyIterator(Object obj) {
        ...
        if (obj != null && obj.getClass().isArray()) {
            return new RangeIterator(Array.getLength((Object)obj));
        }
    ...
    private static Iterator<?> iteratorForJavaArrayOrList(final Object obj) {
        if (obj != null && obj.getClass().isArray()) {
            final int length = Array.getLength((Object)obj);
            return new Iterator<Object>(){
                ...
                public Object next() {
                    ...
                    return Array.get((Object)obj, (int)this.index++);
                }
    ...
    public static boolean sameValue(Object x, Object y) {
        ...
        if (xType == JSType.NUMBER) {
            ...
            if (Double.isNaN((double)xVal) && Double.isNaN((double)yVal)) {
                return true;
            }
            if (xVal == 0.0 && Double.doubleToLongBits((double)xVal) != Double.doubleToLongBits((double)yVal)) {
                return false;
            }
            return xVal == yVal;
        }
        ...
        if (property != null) {
            if (obj instanceof ScriptObject) {
                ...
                if (Global.isLocationPropertyPlaceholder(obj = find != null ? find.getObjectValue() : sobj.invokeNoSuchProperty(property, false, -1))) {
                    obj = CompilerConstants.__LINE__.name().equals(property) ? Integer.valueOf((int)0) : "";
                }
    ...
    public static Object REFERENCE_ERROR(Object lhs, Object rhs, Object msg) {
        throw ECMAErrors.referenceError("cant.be.used.as.lhs", Objects.toString((Object)msg));
    }
    ...
    private static boolean equalSameTypeValues(Object x, Object y, JSType type) {
        ...
        if (type == JSType.STRING) {
            return x.toString().equals((Object)y.toString());
        }
    ...
    public static boolean IN(Object property, Object obj) {
        ...
        if (rvalType == JSType.OBJECT) {
            ...
            if (obj instanceof JSObject) {
                return ((JSObject)obj).hasMember(Objects.toString((Object)property));
            }
            Object key = JSType.toPropertyKey(property);
            if (obj instanceof StaticClass) {
                Class clazz = ((StaticClass)obj).getRepresentedClass();
                return BeansLinker.getReadableStaticPropertyNames((Class)clazz).contains((Object)Objects.toString((Object)key)) || BeansLinker.getStaticMethodNames((Class)clazz).contains((Object)Objects.toString((Object)key));
            }
            ...
            if (index >= 0) {
                ...
                if (obj.getClass().isArray() && index < Array.getLength((Object)obj)) {
                    return true;
                }
            }
            return BeansLinker.getReadableInstancePropertyNames((Class)obj.getClass()).contains((Object)Objects.toString((Object)key)) || BeansLinker.getInstanceMethodNames((Class)obj.getClass()).contains((Object)Objects.toString((Object)key));
        }
    ...
    public static void invalidateReservedBuiltinName(String name) {
        ...
        SwitchPoint.invalidateAll((SwitchPoint[])new SwitchPoint[]{sp});
    }

...
extends NashornLoader {
    ...
    private Module createModule() {
        ModuleDescriptor descriptor = ModuleDescriptor.newModule((String)"org.openjdk.nashorn.structures", (Set)Set.of((Object)ModuleDescriptor.Modifier.SYNTHETIC)).requires(NASHORN_MODULE.getName()).packages(Set.of((Object)"org.openjdk.nashorn.internal.scripts")).build();
        Module mod = Context.createModuleTrusted(NASHORN_MODULE.getLayer(), descriptor, (ClassLoader)this);

...
extends Compiler {
    ...
    private void entryRepeatRange(int id, int lower, int upper) {
        if (this.regex.repeatRangeLo == null) {
            ...
            System.arraycopy((Object)this.regex.repeatRangeLo, (int)0, (Object)tmp, (int)0, (int)this.regex.repeatRangeLo.length);
            this.regex.repeatRangeLo = tmp;
            tmp = new int[this.regex.repeatRangeHi.length + 8];
            System.arraycopy((Object)this.regex.repeatRangeHi, (int)0, (Object)tmp, (int)0, (int)this.regex.repeatRangeHi.length);
    ...
    private void ensure(int size) {
        if (size >= this.code.length) {
            ...
            System.arraycopy((Object)this.code, (int)0, (Object)tmp, (int)0, (int)this.code.length);
            this.code = tmp;
        }
    }
    ...
    private void addObject(Object o) {
        if (this.regex.operands == null) {
            ...
            System.arraycopy((Object)this.regex.operands, (int)0, (Object)tmp, (int)0, (int)this.regex.operands.length);
    ...
    private void addInts(int[] ints, int length) {
        this.ensure(this.codeLength + length);
        System.arraycopy((Object)ints, (int)0, (Object)this.code, (int)this.codeLength, (int)length);
    ...
    private void addTemplate(char[] chars) {
        if (this.templateNum == 0) {
            ...
            System.arraycopy((Object)this.templates, (int)0, (Object)tmp, (int)0, (int)this.templateNum);
            this.templates = tmp;
        }

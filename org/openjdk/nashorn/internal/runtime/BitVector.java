...
implements Cloneable {
    ...
    public void resize(long length) {
        ...
        if (this.bits.length != need) {
            this.bits = Arrays.copyOf((long[])this.bits, (int)need);
        }
    ...
    public void setTo(long length) {
        if (0L < length) {
            ...
            Arrays.fill((long[])this.bits, (int)0, (int)lastWord, (long)-1L);
            if (lastBits != 0L) {
                int n = lastWord;
    ...
    public void clearAll() {
        Arrays.fill((long[])this.bits, (long)0L);
    }
    ...
    public void setRange(long fromIndex, long toIndex) {
        if (fromIndex < toIndex) {
            ...
            if (firstWord == lastWord) {
                ...
                Arrays.fill((long[])this.bits, (int)(firstWord + 1), (int)lastWord, (long)-1L);
                int n2 = lastWord;

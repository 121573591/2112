...
class FastDtoa {
    ...
    static boolean roundWeed(DtoaBuffer buffer, long distance_too_high_w, long unsafe_interval, long rest, long ten_kappa, long unit) {
        ...
        assert (Long.compareUnsigned((long)rest, (long)unsafe_interval) <= 0);
        while (Long.compareUnsigned((long)rest, (long)small_distance) < 0 && Long.compareUnsigned((long)(unsafe_interval - rest), (long)ten_kappa) >= 0 && (Long.compareUnsigned((long)(rest + ten_kappa), (long)small_distance) < 0 || Long.compareUnsigned((long)(small_distance - rest), (long)(rest + ten_kappa - small_distance)) >= 0)) {
            int n = buffer.length - 1;
            buffer.chars[n] = (char)(buffer.chars[n] - '\u0001');
            rest += ten_kappa;
        }
        if (Long.compareUnsigned((long)rest, (long)big_distance) < 0 && Long.compareUnsigned((long)(unsafe_interval - rest), (long)ten_kappa) >= 0 && (Long.compareUnsigned((long)(rest + ten_kappa), (long)big_distance) < 0 || Long.compareUnsigned((long)(big_distance - rest), (long)(rest + ten_kappa - big_distance)) > 0)) {
            return false;
        }
        return Long.compareUnsigned((long)(2L * unit), (long)rest) <= 0 && Long.compareUnsigned((long)rest, (long)(unsafe_interval - 4L * unit)) <= 0;
    }

    static int roundWeedCounted(char[] buffer, int length, long rest, long ten_kappa, long unit) {
        assert (Long.compareUnsigned((long)rest, (long)ten_kappa) < 0);
        if (Long.compareUnsigned((long)unit, (long)ten_kappa) >= 0) {
            return 0;
        }
        if (Long.compareUnsigned((long)(ten_kappa - unit), (long)unit) <= 0) {
            return 0;
        }
        if (Long.compareUnsigned((long)(ten_kappa - rest), (long)rest) > 0 && Long.compareUnsigned((long)(ten_kappa - 2L * rest), (long)(2L * unit)) >= 0) {
            return 1;
        }
        if (Long.compareUnsigned((long)rest, (long)unit) > 0 && Long.compareUnsigned((long)(ten_kappa - (rest - unit)), (long)(rest - unit)) <= 0) {
            int n = length - 1;
    ...
    static boolean digitGen(DiyFp low, DiyFp w, DiyFp high, DtoaBuffer buffer, int mk) {
        ...
        assert (Long.compareUnsigned((long)(low.f() + 1L), (long)(high.f() - 1L)) <= 0);
        ...
        while (kappa > 0) {
            ...
            if (Long.compareUnsigned((long)rest, (long)unsafe_interval.f()) < 0) {
        ...
        assert (Long.compareUnsigned((long)Long.divideUnsigned((long)-1L, (long)10L), (long)one.f()) >= 0);
        do {
            unit *= 10L;
            ...
            buffer.append((char)(48 + digit));
            --kappa;
        } while (Long.compareUnsigned((long)(fractionals &= one.f() - 1L), (long)unsafe_interval.f()) >= 0);
        buffer.decimalPoint = buffer.length - mk + kappa;

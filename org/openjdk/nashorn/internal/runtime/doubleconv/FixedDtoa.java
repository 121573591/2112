...
class FixedDtoa {
    ...
    static void fillDigits32FixedLength(int number, int requested_length, DtoaBuffer buffer) {
        for (int i = requested_length - 1; i >= 0; --i) {
            buffer.chars[buffer.length + i] = (char)(48 + Integer.remainderUnsigned((int)number, (int)10));
            number = Integer.divideUnsigned((int)number, (int)10);
        }
    ...
    static void fillDigits32(int number, DtoaBuffer buffer) {
        int number_length = 0;
        while (number != 0) {
            int digit = Integer.remainderUnsigned((int)number, (int)10);
            number = Integer.divideUnsigned((int)number, (int)10);
    ...
    static void fillDigits64FixedLength(long number, DtoaBuffer buffer) {
        int kTen7 = 10000000;
        int part2 = (int)Long.remainderUnsigned((long)number, (long)10000000L);
        number = Long.divideUnsigned((long)number, (long)10000000L);
        int part1 = (int)Long.remainderUnsigned((long)number, (long)10000000L);
        int part0 = (int)Long.divideUnsigned((long)number, (long)10000000L);
    ...
    static boolean fastFixedDtoa(double v, int fractional_count, DtoaBuffer buffer) {
        ...
        if (exponent + 53 > 64) {
            ...
            if (exponent > 17) {
                quotient = (int)Long.divideUnsigned((long)(dividend <<= exponent - 17), (long)divisor);
                remainder = Long.remainderUnsigned((long)dividend, (long)divisor) << 17;
            } else {
                quotient = (int)Long.divideUnsigned((long)dividend, (long)(divisor <<= 17 - exponent));
                remainder = Long.remainderUnsigned((long)dividend, (long)divisor) << exponent;
            }
            ...
            if (Long.compareUnsigned((long)integrals, (long)0xFFFFFFFFL) > 0) {

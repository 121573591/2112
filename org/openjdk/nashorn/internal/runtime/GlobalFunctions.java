...
public final class GlobalFunctions {
    ...
    public static double parseFloat(Object self, Object string) {
        ...
        try {
            double result = Double.parseDouble((String)str.substring(start, end));
    ...
    public static boolean isNaN(Object self, Object number) {
        return Double.isNaN((double)JSType.toNumber(number));
    }
    ...
    public static String escape(Object self, Object string) {
        ...
        for (int k = 0; k < length; ++k) {
            ...
            if (ch < '\u0100') {
                ...
                sb.append(Integer.toHexString((int)ch).toUpperCase(Locale.ENGLISH));
                continue;
            }
            sb.append("%u");
            if (ch < '\u1000') {
        ...
        for (int k = 0; k < length; ++k) {
            ...
            if (ch == '%') {
                if (k < length - 5 && str.charAt(k + 1) == 'u') {
                    try {
                        ch = (char)Integer.parseInt((String)str.substring(k + 2, k + 6), (int)16);
                        sb.append(ch);
                        k += 5;
                        continue;
                    }
                ...
                if (k < length - 2) {
                    try {
                        ch = (char)Integer.parseInt((String)str.substring(k + 1, k + 3), (int)16);
                        sb.append(ch);
                        k += 2;
                        continue;
                    }

...
extends NashornException {
    ...
    public ParserException(JSErrorType errorType, String msg, Source source2, int line, int column, long token) {
        super(msg, source2 != null ? source2.getName() : null, line, column);
        this.source = source2;
        this.token = token;

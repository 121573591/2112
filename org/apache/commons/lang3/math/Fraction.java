...
implements Comparable<Fraction> {
    ...
    public static Fraction getFraction(double value) {
        ...
        if ((value = Math.abs((double)value)) > 2.147483647E9 || Double.isNaN((double)value)) {
        ...
        do {
            ...
            delta2 = Math.abs((double)(value - fraction));
            a1 = a2;
            x1 = x2;
            y1 = y2;
            numer0 = numer1;
    ...
    public static Fraction getFraction(String str) {
        Objects.requireNonNull((Object)str, (String)"str");
        int pos = str.indexOf(46);
        if (pos >= 0) {
            return Fraction.getFraction(Double.parseDouble((String)str));
        }
        pos = str.indexOf(32);
        if (pos > 0) {
            int whole = Integer.parseInt((String)str.substring(0, pos));
            if ((pos = (str = str.substring(pos + 1)).indexOf(47)) < 0) {
                throw new NumberFormatException("The fraction could not be parsed as the format X Y/Z");
            }
            int numer = Integer.parseInt((String)str.substring(0, pos));
            int denom = Integer.parseInt((String)str.substring(pos + 1));
            return Fraction.getFraction(whole, numer, denom);
        }
        pos = str.indexOf(47);
        if (pos < 0) {
            return Fraction.getFraction(Integer.parseInt((String)str), 1);
        }
        int numer = Integer.parseInt((String)str.substring(0, pos));
        int denom = Integer.parseInt((String)str.substring(pos + 1));
    ...
    private static int greatestCommonDivisor(int u, int v) {
        ...
        if (u == 0 || v == 0) {
            ...
            return Math.abs((int)u) + Math.abs((int)v);
        }
        if (Math.abs((int)u) == 1 || Math.abs((int)v) == 1) {
            return 1;
        }
        if (u > 0) {
            u = -u;
    ...
    private Fraction addSub(Fraction fraction, boolean isAdd) {
        int tmodd1;
        int d2;
        Objects.requireNonNull((Object)((Object)fraction), (String)"fraction");
        if (this.numerator == 0) {
        ...
        BigInteger w = t.divide(BigInteger.valueOf((long)(d2 = (tmodd1 = t.mod(BigInteger.valueOf((long)d1)).intValue()) == 0 ? d1 : Fraction.greatestCommonDivisor(tmodd1, d1))));
        if (w.bitLength() > 31) {
    ...
    public boolean equals(Object obj) {
        ...
        Fraction other = (Fraction)((Object)obj);
    ...
    public int getProperNumerator() {
        return Math.abs((int)(this.numerator % this.denominator));
    }
    ...
    public Fraction reduce() {
        if (this.numerator == 0) {
            return this.equals((Object)ZERO) ? this : ZERO;
        }
        int gcd = Fraction.greatestCommonDivisor(Math.abs((int)this.numerator), this.denominator);
        if (gcd == 1) {
            return this;
        }
    ...
    public String toProperString() {
        if (this.toProperString == null) {
            int properNumerator;
            this.toProperString = this.numerator == 0 ? "0" : (this.numerator == this.denominator ? "1" : (this.numerator == -1 * this.denominator ? "-1" : ((this.numerator > 0 ? -this.numerator : this.numerator) < -this.denominator ? ((properNumerator = this.getProperNumerator()) == 0 ? Integer.toString((int)this.getProperWhole()) : this.getProperWhole() + " " + properNumerator + "/" + this.getDenominator()) : this.getNumerator() + "/" + this.getDenominator())));
        }

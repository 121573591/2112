...
extends Pair<L, R> {
    ...
    public static <L, R> ImmutablePair<L, R> of(Map.Entry<L, R> pair) {
        return pair != null ? new ImmutablePair<Object, Object>(pair.getKey(), pair.getValue()) : ImmutablePair.nullPair();
    }

    public static <L, R> ImmutablePair<L, R> ofNonNull(L left, R right) {
        return ImmutablePair.of(Objects.requireNonNull(left, (String)"left"), Objects.requireNonNull(right, (String)"right"));
    }

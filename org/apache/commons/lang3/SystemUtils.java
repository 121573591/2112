...
public class SystemUtils {
    ...
    public static final String USER_COUNTRY = SystemProperties.getProperty("user.country", (Supplier<String>)((Supplier)() -> SystemProperties.getProperty("user.region")));
    ...
    public static String getHostName() {
        return IS_OS_WINDOWS ? System.getenv((String)"COMPUTERNAME") : System.getenv((String)"HOSTNAME");
    }
    ...
    public static String getUserName(String defaultValue) {
        return System.getProperty((String)USER_NAME_KEY, (String)defaultValue);
    }

    public static boolean isJavaAwtHeadless() {
        return Boolean.TRUE.toString().equals((Object)JAVA_AWT_HEADLESS);
    }
    ...
    static boolean isOSVersionMatch(String osVersion, String osVersionPrefix) {
        ...
        for (int i = 0; i < Math.min((int)versionPrefixParts.length, (int)versionParts.length); ++i) {
            if (versionPrefixParts[i].equals((Object)versionParts[i])) continue;
            return false;
        }
        return true;
    }

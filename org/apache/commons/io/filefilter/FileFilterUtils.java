...
public class FileFilterUtils {
    ...
    public static File[] filter(IOFileFilter filter, File ... files) {
        ...
        return (File[])((List)FileFilterUtils.filterFiles(filter, (Stream<File>)Stream.of((Object[])files), Collectors.toList())).toArray((Object[])FileUtils.EMPTY_FILE_ARRAY);
    }
    ...
    public static File[] filter(IOFileFilter filter, Iterable<File> files) {
        return (File[])FileFilterUtils.filterList(filter, files).toArray((Object[])FileUtils.EMPTY_FILE_ARRAY);
    }

    public static List<File> filterList(IOFileFilter filter, File ... files) {
        return Arrays.asList((Object[])FileFilterUtils.filter(filter, files));
    }
    ...
    public static List<File> filterList(IOFileFilter filter, Iterable<File> files) {
        ...
        return (List)FileFilterUtils.filterFiles(filter, (Stream<File>)StreamSupport.stream((Spliterator)files.spliterator(), (boolean)false), Collectors.toList());
    }

    public static Set<File> filterSet(IOFileFilter filter, File ... files) {
        return new HashSet((Collection)Arrays.asList((Object[])FileFilterUtils.filter(filter, files)));
    }
    ...
    public static Set<File> filterSet(IOFileFilter filter, Iterable<File> files) {
        ...
        return (Set)FileFilterUtils.filterFiles(filter, (Stream<File>)StreamSupport.stream((Spliterator)files.spliterator(), (boolean)false), Collectors.toSet());
    }

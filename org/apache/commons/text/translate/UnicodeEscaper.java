...
extends CodePointTranslator {
    ...
    public boolean translate(int codePoint, Writer writer) throws IOException {
        ...
        if (codePoint > 65535) {
            ...
            writer.write("\\u");
            writer.write((int)HEX_DIGITS[codePoint >> 12 & 0xF]);
            writer.write((int)HEX_DIGITS[codePoint >> 8 & 0xF]);
            writer.write((int)HEX_DIGITS[codePoint >> 4 & 0xF]);
            writer.write((int)HEX_DIGITS[codePoint & 0xF]);
        }
        return true;
    }
}

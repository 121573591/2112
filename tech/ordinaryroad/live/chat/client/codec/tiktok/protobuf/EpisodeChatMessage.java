...
import tech.ordinaryroad.live.chat.client.codec.tiktok.protobuf.EpisodeChatMessageOrBuilder;
import tech.ordinaryroad.live.chat.client.codec.tiktok.protobuf.Tiktok;

public final class EpisodeChatMessage
extends GeneratedMessageV3
implements EpisodeChatMessageOrBuilder {
    private static final long serialVersionUID = 0L;
    private byte memoizedIsInitialized = (byte)-1;
    private static final EpisodeChatMessage DEFAULT_INSTANCE = new EpisodeChatMessage();
    private static final Parser<EpisodeChatMessage> PARSER = new AbstractParser<EpisodeChatMessage>(){
        ...
        public EpisodeChatMessage parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = EpisodeChatMessage.newBuilder();
            try {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + EpisodeChatMessage.getDescriptor().hashCode();
    ...
    public Builder newBuilderForType() {
        return EpisodeChatMessage.newBuilder();
    }
    ...
    implements EpisodeChatMessageOrBuilder {
        ...
        public EpisodeChatMessage build() {
            EpisodeChatMessage result = this.buildPartial();
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof EpisodeChatMessage) {
                return this.mergeFrom((EpisodeChatMessage)other);
            }

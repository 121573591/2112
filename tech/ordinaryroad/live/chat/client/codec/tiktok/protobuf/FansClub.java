...
import tech.ordinaryroad.live.chat.client.codec.tiktok.protobuf.FansClubOrBuilder;
import tech.ordinaryroad.live.chat.client.codec.tiktok.protobuf.Tiktok;

public final class FansClub
extends GeneratedMessageV3
implements FansClubOrBuilder {
    private static final long serialVersionUID = 0L;
    private byte memoizedIsInitialized = (byte)-1;
    private static final FansClub DEFAULT_INSTANCE = new FansClub();
    private static final Parser<FansClub> PARSER = new AbstractParser<FansClub>(){
        ...
        public FansClub parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = FansClub.newBuilder();
            try {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + FansClub.getDescriptor().hashCode();
    ...
    implements FansClubOrBuilder {
        ...
        public FansClub build() {
            FansClub result = this.buildPartial();
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof FansClub) {
                return this.mergeFrom((FansClub)other);
            }

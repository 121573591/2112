...
import tech.ordinaryroad.live.chat.client.codec.tiktok.protobuf.UpdateFanTicketMessageOrBuilder;

public final class UpdateFanTicketMessage
extends GeneratedMessageV3
implements UpdateFanTicketMessageOrBuilder {
    private static final long serialVersionUID = 0L;
    private byte memoizedIsInitialized = (byte)-1;
    private static final UpdateFanTicketMessage DEFAULT_INSTANCE = new UpdateFanTicketMessage();
    private static final Parser<UpdateFanTicketMessage> PARSER = new AbstractParser<UpdateFanTicketMessage>(){
        ...
        public UpdateFanTicketMessage parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = UpdateFanTicketMessage.newBuilder();
            try {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + UpdateFanTicketMessage.getDescriptor().hashCode();
    ...
    public Builder newBuilderForType() {
        return UpdateFanTicketMessage.newBuilder();
    }
    ...
    implements UpdateFanTicketMessageOrBuilder {
        ...
        public UpdateFanTicketMessage build() {
            UpdateFanTicketMessage result = this.buildPartial();
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof UpdateFanTicketMessage) {
                return this.mergeFrom((UpdateFanTicketMessage)other);
            }

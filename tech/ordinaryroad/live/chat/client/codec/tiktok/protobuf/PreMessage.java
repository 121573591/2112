...
import tech.ordinaryroad.live.chat.client.codec.tiktok.protobuf.PreMessageOrBuilder;
...
implements PreMessageOrBuilder {
    ...
    private static final Parser<PreMessage> PARSER = new AbstractParser<PreMessage>(){
        ...
        public PreMessage parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = PreMessage.newBuilder();
            try {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + PreMessage.getDescriptor().hashCode();
    ...
    implements PreMessageOrBuilder {
        ...
        public PreMessage build() {
            PreMessage result = this.buildPartial();
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof PreMessage) {
                return this.mergeFrom((PreMessage)other);
            }

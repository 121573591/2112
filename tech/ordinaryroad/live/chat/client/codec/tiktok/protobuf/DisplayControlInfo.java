...
import tech.ordinaryroad.live.chat.client.codec.tiktok.protobuf.DisplayControlInfoOrBuilder;
import tech.ordinaryroad.live.chat.client.codec.tiktok.protobuf.Tiktok;

public final class DisplayControlInfo
extends GeneratedMessageV3
implements DisplayControlInfoOrBuilder {
    private static final long serialVersionUID = 0L;
    private byte memoizedIsInitialized = (byte)-1;
    private static final DisplayControlInfo DEFAULT_INSTANCE = new DisplayControlInfo();
    private static final Parser<DisplayControlInfo> PARSER = new AbstractParser<DisplayControlInfo>(){
        ...
        public DisplayControlInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = DisplayControlInfo.newBuilder();
            try {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + DisplayControlInfo.getDescriptor().hashCode();
    ...
    public Builder newBuilderForType() {
        return DisplayControlInfo.newBuilder();
    }
    ...
    implements DisplayControlInfoOrBuilder {
        ...
        public DisplayControlInfo build() {
            DisplayControlInfo result = this.buildPartial();
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof DisplayControlInfo) {
                return this.mergeFrom((DisplayControlInfo)other);
            }

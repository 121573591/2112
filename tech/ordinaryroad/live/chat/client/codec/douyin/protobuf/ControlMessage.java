...
import tech.ordinaryroad.live.chat.client.codec.douyin.protobuf.ControlMessageOrBuilder;
...
implements ControlMessageOrBuilder {
    ...
    private static final Parser<ControlMessage> PARSER = new AbstractParser<ControlMessage>(){
        ...
        public ControlMessage parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = ControlMessage.newBuilder();
            try {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + ControlMessage.getDescriptor().hashCode();
        if (this.hasCommon()) {
            hash = 37 * hash + 1;
    ...
    implements ControlMessageOrBuilder {
        ...
        public ControlMessage build() {
            ControlMessage result = this.buildPartial();
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof ControlMessage) {
                return this.mergeFrom((ControlMessage)other);
            }

...
public final class SCPingAckOuterClass {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        SCPingAckOuterClass.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        internal_static_SCPingAck_descriptor = (Descriptors.Descriptor)SCPingAckOuterClass.getDescriptor().getMessageTypes().get(0);
    ...
    public static final class SCPingAck
    extends GeneratedMessageV3
    implements SCPingAckOrBuilder {
        ...
        private static final Parser<SCPingAck> PARSER = new AbstractParser<SCPingAck>(){

            @Override
            public SCPingAck parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                Builder builder = SCPingAck.newBuilder();
                try {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return internal_static_SCPingAck_descriptor;
        }

        @Override
        protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return internal_static_SCPingAck_fieldAccessorTable.ensureFieldAccessorsInitialized(SCPingAck.class, Builder.class);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (!this.getEchoData().equals((Object)other.getEchoData())) {
                return false;
            }
        ...
        public int hashCode() {
            ...
            int hash = 41;
            hash = 19 * hash + SCPingAck.getDescriptor().hashCode();
            hash = 37 * hash + 1;
            hash = 53 * hash + this.getEchoData().hashCode();
        ...
        implements SCPingAckOrBuilder {
            ...
            public SCPingAck build() {
                SCPingAck result = this.buildPartial();
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof SCPingAck) {
                    return this.mergeFrom((SCPingAck)other);
                }
            ...
            public Builder mergeFrom(SCPingAck other) {
                if (other == SCPingAck.getDefaultInstance()) {
                    return this;
                }
            ...
            public Builder clearEchoData() {
                this.echoData_ = SCPingAck.getDefaultInstance().getEchoData();
            ...
            public Builder setEchoDataBytes(ByteString value) {
                ...
                SCPingAck.checkByteStringIsUtf8(value);
                this.echoData_ = value;
                this.bitField0_ |= 1;
                this.onChanged();
                return this;
    ...
    public static interface SCPingAckOrBuilder

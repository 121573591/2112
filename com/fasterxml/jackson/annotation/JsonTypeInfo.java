...
public @interface JsonTypeInfo {
    ...
    Serializable {
        ...
        public String toString() {
            return String.format((String)"JsonTypeInfo.Value(idType=%s,includeAs=%s,propertyName=%s,defaultImpl=%s,idVisible=%s,requireTypeIdForSubtypes=%s)", (Object[])new Object[]{this._idType, this._inclusionType, this._propertyName, this._defaultImpl == null ? "NULL" : this._defaultImpl.getName(), this._idVisible, this._requireTypeIdForSubtypes});
        }

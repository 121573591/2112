...
implements Serializable {
    ...
    public JsonSerializer<?> findSerializer(SerializationConfig config, JavaType type, BeanDescription beanDesc) {
        ...
        if (cls.isInterface()) {
            if (this._interfaceMappings != null && (ser = (JsonSerializer<?>)this._interfaceMappings.get((Object)key)) != null) {
                return ser;
            }
        } else if (this._classMappings != null) {
            ser = (JsonSerializer)this._classMappings.get((Object)key);
            if (ser != null) {
                return ser;
            }
    ...
    protected JsonSerializer<?> _findInterfaceMapping(Class<?> cls, ClassKey key) {
        for (Class iface : cls.getInterfaces()) {
            key.reset(iface);
            JsonSerializer<?> ser = (JsonSerializer<?>)this._interfaceMappings.get((Object)key);
            if (ser != null) {
                return ser;
            }
    ...
    protected void _addSerializer(Class<?> cls, JsonSerializer<?> ser) {
        ...
        if (cls.isInterface()) {
            ...
            this._interfaceMappings.put((Object)key, ser);
        } else {
            if (this._classMappings == null) {
                this._classMappings = new HashMap();
            }
            this._classMappings.put((Object)key, ser);
            if (cls == Enum.class) {

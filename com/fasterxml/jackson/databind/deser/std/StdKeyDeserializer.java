...
implements Serializable {
    ...
    protected Object _parse(String key, DeserializationContext ctxt) throws Exception {
        switch (this._kind) {
            case 1: {
                if ("true".equals((Object)key)) {
                    return Boolean.TRUE;
                }
                if ("false".equals((Object)key)) {
            ...
            case 4: {
                if (key.length() == 1) {
                    return Character.valueOf((char)key.charAt(0));
                }
            ...
            case 7: {
                return Float.valueOf((float)((float)this._parseDouble(key)));
            }
            case 8: {
            ...
            case 9: {
                try {
                    ...
                    return this._weirdKey(ctxt, key, (Exception)((Object)e));
                }
            }
            case 16: {
                try {

        ...
        if (this._valueInstantiator != null) {
            if (this._valueInstantiator.canCreateUsingDelegate()) {
                ...
                if (delegateType == null) {
                    ctxt.reportBadDefinition(this._containerType, String.format((String)"Invalid delegate-creator definition for %s: value instantiator (%s) returned true for 'canCreateUsingDelegate()', but null for 'getDelegateType()'", (Object[])new Object[]{this._containerType, this._valueInstantiator.getClass().getName()}));
                }
                ...
                if (delegateType == null) {
                    ctxt.reportBadDefinition(this._containerType, String.format((String)"Invalid delegate-creator definition for %s: value instantiator (%s) returned true for 'canCreateUsingArrayDelegate()', but null for 'getArrayDelegateType()'", (Object[])new Object[]{this._containerType, this._valueInstantiator.getClass().getName()}));
                }
                this._delegateDeserializer = this.findDeserializer(ctxt, delegateType, null);

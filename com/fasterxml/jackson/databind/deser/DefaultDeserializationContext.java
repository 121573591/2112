...
implements Serializable {
    ...
    public ReadableObjectId findObjectId(Object id, ObjectIdGenerator<?> gen, ObjectIdResolver resolverType) {
        ...
        if (this._objectIds == null) {
            ...
            ReadableObjectId entry = (ReadableObjectId)this._objectIds.get((Object)key);
            if (entry != null) {
                return entry;
            }
        }
        ...
        if (resolver == null) {
            ...
            this._objectIdResolvers.add((Object)resolver);
        }
        ReadableObjectId entry = this.createReadableObjectId(key);
        entry.setResolver(resolver);
        this._objectIds.put((Object)key, (Object)entry);
        return entry;
    }
    ...
    protected Object _unwrapAndDeserialize(JsonParser p, JavaType rootType, JsonDeserializer<Object> deser, Object valueToUpdate) throws IOException {
        ...
        if (!expSimpleName.equals((Object)(actualName = p.currentName()))) {

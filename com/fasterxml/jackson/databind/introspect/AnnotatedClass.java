...
implements TypeResolutionContext {
    private static final Creators NO_CREATORS = new Creators(null, (List<AnnotatedConstructor>)Collections.emptyList(), (List<AnnotatedMethod>)Collections.emptyList());
    ...
    public boolean isNonStaticInnerClass() {
        ...
        if (B == null) {
            this._nonStaticInnerClass = B = Boolean.valueOf((boolean)ClassUtil.isNonStaticInnerClass(this._class));
        }
        return B;
    }

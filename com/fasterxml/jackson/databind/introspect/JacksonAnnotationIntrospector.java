...
implements Serializable {
    ...
    public String findEnumValue(Enum<?> value) {
        try {
            ...
            if (f != null && (prop = (JsonProperty)f.getAnnotation(JsonProperty.class)) != null && (n = prop.value()) != null && !n.isEmpty()) {
                return n;
            }
        }
    ...
    public String[] findEnumValues(Class<?> enumType, Enum<?>[] enumValues, String[] names) {
        ...
        for (Field f : enumType.getDeclaredFields()) {
            String n;
            JsonProperty prop;
            if (!f.isEnumConstant() || (prop = (JsonProperty)f.getAnnotation(JsonProperty.class)) == null || (n = prop.value()).isEmpty()) continue;
            if (expl == null) {
                expl = new HashMap();
            }
            expl.put((Object)f.getName(), (Object)n);
        }
        if (expl != null) {
            int end = enumValues.length;
            for (int i = 0; i < end; ++i) {
                String defName = enumValues[i].name();
                String explValue = (String)expl.get((Object)defName);
    ...
    public String[] findEnumValues(MapperConfig<?> config, AnnotatedClass annotatedClass, Enum<?>[] enumValues, String[] names) {
        LinkedHashMap enumToPropertyMap = new LinkedHashMap();
        for (AnnotatedField field : annotatedClass.fields()) {
            String propValue;
            JsonProperty property = field.getAnnotation(JsonProperty.class);
            if (property == null || (propValue = property.value()) == null || propValue.isEmpty()) continue;
            enumToPropertyMap.put((Object)field.getName(), (Object)propValue);
        }
        int end = enumValues.length;
        for (int i = 0; i < end; ++i) {
            String defName = enumValues[i].name();
            String explValue = (String)enumToPropertyMap.get((Object)defName);
            if (explValue == null) continue;
            names[i] = explValue;
        }
        return names;
    ...
    public void findEnumAliases(Class<?> enumType, Enum<?>[] enumValues, String[][] aliasList) {
        for (Field f : enumType.getDeclaredFields()) {
            ...
            if (!f.isEnumConstant() || (aliasAnnotation = (JsonAlias)f.getAnnotation(JsonAlias.class)) == null || (aliases = aliasAnnotation.value()).length == 0) continue;
            String name = f.getName();
            int end = enumValues.length;
            for (int i = 0; i < end; ++i) {
                if (!name.equals((Object)enumValues[i].name())) continue;
                aliasList[i] = aliases;
            }
        }
    }
    ...
    public void findEnumAliases(MapperConfig<?> config, AnnotatedClass annotatedClass, Enum<?>[] enumValues, String[][] aliasList) {
        HashMap enumToAliasMap = new HashMap();
        for (AnnotatedField field : annotatedClass.fields()) {
            JsonAlias alias = field.getAnnotation(JsonAlias.class);
            if (alias == null) continue;
            enumToAliasMap.putIfAbsent((Object)field.getName(), (Object)alias.value());
        }
        for (Enum<?> enumValue : enumValues) {
            aliasList[i] = (String[])enumToAliasMap.getOrDefault((Object)enumValue.name(), (Object)new String[0]);
        }
    }
    ...
    public Enum<?> findDefaultEnumValue(AnnotatedClass annotatedClass, Enum<?>[] enumValues) {
        for (Annotated field : annotatedClass.fields()) {
            ...
            if (!field.getType().isEnumType() || (found = this._findAnnotation(field, JsonEnumDefaultValue.class)) == null) continue;
            for (Enum<?> enumValue : enumValues) {
                if (!enumValue.name().equals((Object)field.getName())) continue;
                return enumValue;
            }
        }
        return null;
    ...
    public Boolean isIgnorableType(AnnotatedClass ac) {
        ...
        return ignore == null ? null : Boolean.valueOf((boolean)ignore.value());
    }
    ...
    public List<PropertyName> findPropertyAliases(Annotated m) {
        ...
        for (int i = 0; i < len; ++i) {
            result.add((Object)PropertyName.construct(strs[i]));
        }
        return result;
    }
    ...
    public List<NamedType> findSubtypes(Annotated a) {
        ...
        for (JsonSubTypes.Type type : types) {
            result.add((Object)new NamedType(type.value(), type.name()));
            for (String name : type.names()) {
                result.add((Object)new NamedType(type.value(), name));
            }
        }
        return result;
    }
    ...
    private List<NamedType> findSubtypesCheckRepeatedNames(String annotatedTypeName, JsonSubTypes.Type[] types) {
        ...
        for (JsonSubTypes.Type type : types) {
            ...
            if (!typeName.isEmpty() && seenNames.contains((Object)typeName)) {
                throw new IllegalArgumentException("Annotated type [" + annotatedTypeName + "] got repeated subtype name [" + typeName + "]");
            }
            seenNames.add((Object)typeName);
            result.add((Object)new NamedType(type.value(), typeName));
            for (String altName : type.names()) {
                if (!altName.isEmpty() && seenNames.contains((Object)altName)) {
                    throw new IllegalArgumentException("Annotated type [" + annotatedTypeName + "] got repeated subtype name [" + altName + "]");
                }
                seenNames.add((Object)altName);
                result.add((Object)new NamedType(type.value(), altName));
            }
        }
        return result;
    }
            ...
            if (serClass != null) {
                if (type.hasRawClass(serClass)) {
                    ...
                    try {
                        ...
                        throw this._databindException(String.format((String)"Cannot refine serialization type %s into %s; types not related", (Object[])new Object[]{type, serClass.getName()}));
                    }
                    catch (IllegalArgumentException iae) {
                        throw this._databindException(iae, String.format((String)"Failed to widen type %s with annotation (value %s), from '%s': %s", (Object[])new Object[]{type, serClass.getName(), a.getName(), iae.getMessage()}));
                    }
                }
            }
        }
                ...
                block27: {
                    if (keyType.hasRawClass(keyClass)) {
                        ...
                        try {
                            ...
                            throw this._databindException(String.format((String)"Cannot refine serialization key type %s into %s; types not related", (Object[])new Object[]{keyType, keyClass.getName()}));
                        }
                        catch (IllegalArgumentException iae) {
                            throw this._databindException(iae, String.format((String)"Failed to widen key type of %s with concrete-type annotation (value %s), from '%s': %s", (Object[])new Object[]{type, keyClass.getName(), a.getName(), iae.getMessage()}));
                        }
                    }
                }
                ...
                block28: {
                    if (contentType.hasRawClass(contentClass)) {
                        ...
                        try {
                            ...
                            throw this._databindException(String.format((String)"Cannot refine serialization content type %s into %s; types not related", (Object[])new Object[]{contentType, contentClass.getName()}));
                        }
                        catch (IllegalArgumentException iae) {
                            throw this._databindException(iae, String.format((String)"Internal error: failed to refine value type of %s with concrete-type annotation (value %s), from '%s': %s", (Object[])new Object[]{type, contentClass.getName(), a.getName(), iae.getMessage()}));
                        }
                    }
                }
    ...
    public void findAndAddVirtualProperties(MapperConfig<?> config, AnnotatedClass ac, List<BeanPropertyWriter> properties) {
        ...
        for (int i = 0; i < len; ++i) {
            ...
            if (prepend) {
                properties.add(i, (Object)bpw);
                continue;
            }
            properties.add((Object)bpw);
        }
    ...
    public JavaType refineDeserializationType(MapperConfig<?> config, Annotated a, JavaType baseType) throws JsonMappingException {
        ...
        if (valueClass != null && !type.hasRawClass(valueClass) && !this._primitiveAndWrapper(type, valueClass)) {
            try {
                ...
                throw this._databindException(iae, String.format((String)"Failed to narrow type %s with annotation (value %s), from '%s': %s", (Object[])new Object[]{type, valueClass.getName(), a.getName(), iae.getMessage()}));
            }
        }
        if (type.isMapLikeType()) {
            Class<?> keyClass;
            ...
            if (keyClass != null && !this._primitiveAndWrapper(keyType, keyClass)) {
                try {
                    ...
                    throw this._databindException(iae, String.format((String)"Failed to narrow key type of %s with concrete-type annotation (value %s), from '%s': %s", (Object[])new Object[]{type, keyClass.getName(), a.getName(), iae.getMessage()}));
                }
            }
        }
        if ((contentType = type.getContentType()) != null) {
            ...
            if (contentClass != null && !this._primitiveAndWrapper(contentType, contentClass)) {
                try {
                    ...
                    throw this._databindException(iae, String.format((String)"Failed to narrow value type of %s with concrete-type annotation (value %s), from '%s': %s", (Object[])new Object[]{type, contentClass.getName(), a.getName(), iae.getMessage()}));
                }
            }
        }
        return type;
    ...
    public Boolean hasAnySetter(Annotated a) {
        ...
        return ann == null ? null : Boolean.valueOf((boolean)ann.enabled());
    }

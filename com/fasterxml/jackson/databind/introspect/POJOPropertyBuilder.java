...
implements Comparable<POJOPropertyBuilder> {
    ...
    protected PropertyMetadata _getSetterInfo(PropertyMetadata metadata, AnnotatedMember primary) {
        ...
        if (needMerge || valueNulls == null || contentNulls == null) {
            ...
            if (needMerge && Boolean.TRUE.equals((Object)(b = this._config.getDefaultMergeable())) && acc != null) {
    ...
    protected AnnotatedMethod _selectSetterFromMultiple(Linked<AnnotatedMethod> curr, Linked<AnnotatedMethod> next) {
        ...
        String desc = (String)conflicts.stream().map(AnnotatedMethod::getFullName).collect(Collectors.joining((CharSequence)" vs "));
        throw new IllegalArgumentException(String.format((String)"Conflicting setter definitions for property \"%s\": %s", (Object[])new Object[]{this.getName(), desc}));
    }
    ...
    public Collection<POJOPropertyBuilder> explode(Collection<PropertyName> newNames) {
        ...
        this._explode(newNames, (Map<PropertyName, POJOPropertyBuilder>)props, this._fields);
        this._explode(newNames, (Map<PropertyName, POJOPropertyBuilder>)props, this._getters);
        this._explode(newNames, (Map<PropertyName, POJOPropertyBuilder>)props, this._setters);
        this._explode(newNames, (Map<PropertyName, POJOPropertyBuilder>)props, this._ctorParameters);
        return props.values();
    }
    ...
    private void _explode(Collection<PropertyName> newNames, Map<PropertyName, POJOPropertyBuilder> props, Linked<?> accessors) {
        ...
        while (node != null) {
            ...
            if (!node.isNameExplicit || name == null) {
                ...
                Linked<Object> n2;
                POJOPropertyBuilder prop = (POJOPropertyBuilder)props.get((Object)name);
                if (prop == null) {
    ...
    public String toString() {
        ...
        sb.append("[Property '").append((Object)this._name).append("'; ctors: ").append(this._ctorParameters).append(", field(s): ").append(this._fields).append(", getter(s): ").append(this._getters).append(", setter(s): ").append(this._setters);
        sb.append("]");
        return sb.toString();
    }
    ...
    protected static final class Linked<T> {
        ...
        public String toString() {
            String msg = String.format((String)"%s[visible=%b,ignore=%b,explicitName=%b]", (Object[])new Object[]{this.value.toString(), this.isVisible, this.isMarkedIgnored, this.isNameExplicit});
            if (this.next != null) {

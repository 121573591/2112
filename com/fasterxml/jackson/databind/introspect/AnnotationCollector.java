...
public abstract class AnnotationCollector {
    ...
    extends AnnotationCollector {
        ...
        public NCollector(Object data, Class<?> type1, Annotation value1, Class<?> type2, Annotation value2) {
            super(data);
            this._annotations.put(type1, (Object)value1);
            this._annotations.put(type2, (Object)value2);
        }
        ...
        public boolean isPresent(Annotation ann) {
            return this._annotations.containsKey((Object)ann.annotationType());
        }

        @Override
        public AnnotationCollector addOrOverride(Annotation ann) {
            this._annotations.put((Object)ann.annotationType(), (Object)ann);
            return this;
        }
    }

    ...
    static final class IteratorStack {
        ...
        public void push(Iterator<?> it) {
            ...
            if (this._stack == null) {
                ...
                this._end += Math.min((int)4000, (int)Math.max((int)20, (int)(this._end >> 1)));
                this._stack = (Iterator[])Arrays.copyOf((Object[])this._stack, (int)this._end);
            }
            this._stack[this._top++] = it;
        }
                ...
                if (currIt.hasNext()) {
                    ...
                    if (value instanceof POJONode) {
                        try {
                            ...
                            g.writeString(String.format((String)"[ERROR: (%s) %s]", (Object[])new Object[]{e.getClass().getName(), e.getMessage()}));
                        }
                        continue;
                    }
                    value.serialize(g, this._context);

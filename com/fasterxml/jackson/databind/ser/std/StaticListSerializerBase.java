...
implements ContextualSerializer {
    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializers, BeanProperty property) throws JsonMappingException {
        ...
        if (this.isDefaultSerializer(ser)) {
            if (Objects.equals((Object)unwrapSingle, (Object)this._unwrapSingle)) {
                return this;
            }
            return this._withResolved(property, unwrapSingle);
        }
        return new CollectionSerializer(serializers.constructType((Type)String.class), true, null, ser);
    }

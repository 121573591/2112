...
implements Serializable {
    ...
    public BeanPropertyWriter rename(NameTransformer transformer) {
        ...
        if (newName.equals((Object)this._name.toString())) {
            return this;
        }
    ...
    public void assignSerializer(JsonSerializer<Object> ser) {
        if (this._serializer != null && this._serializer != ser) {
            throw new IllegalStateException(String.format((String)"Cannot override _serializer: had a %s, trying to set to %s", (Object[])new Object[]{ClassUtil.classNameOf(this._serializer), ClassUtil.classNameOf(ser)}));
        }
        this._serializer = ser;
    }
    ...
    public void assignNullSerializer(JsonSerializer<Object> nullSer) {
        if (this._nullSerializer != null && this._nullSerializer != nullSer) {
            throw new IllegalStateException(String.format((String)"Cannot override _nullSerializer: had a %s, trying to set to %s", (Object[])new Object[]{ClassUtil.classNameOf(this._nullSerializer), ClassUtil.classNameOf(nullSer)}));
        }
    ...
    public void depositSchemaProperty(ObjectNode propertiesNode, SerializerProvider provider) throws JsonMappingException {
        ...
        Class<?> hint = propType == null ? this.getType() : propType.getRawClass();
        ...
        JsonNode schemaNode = ser instanceof SchemaAware ? ((SchemaAware)((Object)ser)).getSchema(provider, (Type)hint, isOptional) : JsonSchema.getDefaultSchemaNode();

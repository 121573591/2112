    ...
    public static class Builder {
        ...
        public Builder allowIfBaseType(final Pattern patternForBase) {
            return this._appendBaseMatcher(new TypeMatcher(){
                ...
                @Override
                public boolean match(MapperConfig<?> config, Class<?> clazz) {
                    return patternForBase.matcher((CharSequence)clazz.getName()).matches();
                }
            });
        }
        ...
        public Builder allowIfSubType(final Pattern patternForSubType) {
            return this._appendSubNameMatcher(new NameMatcher(){
                ...
                public boolean match(MapperConfig<?> config, String clazzName) {
                    return patternForSubType.matcher((CharSequence)clazzName).matches();
                }
            });
        }
        ...
        public BasicPolymorphicTypeValidator build() {
            return new BasicPolymorphicTypeValidator(this._invalidBaseTypes, this._baseTypeMatchers == null ? null : (TypeMatcher[])this._baseTypeMatchers.toArray((Object[])new TypeMatcher[0]), this._subTypeNameMatchers == null ? null : (NameMatcher[])this._subTypeNameMatchers.toArray((Object[])new NameMatcher[0]), this._subTypeClassMatchers == null ? null : (TypeMatcher[])this._subTypeClassMatchers.toArray((Object[])new TypeMatcher[0]));
        }
        ...
        protected Builder _appendBaseMatcher(TypeMatcher matcher) {
            ...
            this._baseTypeMatchers.add((Object)matcher);
            return this;
        }
        ...
        protected Builder _appendSubNameMatcher(NameMatcher matcher) {
            ...
            this._subTypeNameMatchers.add((Object)matcher);
            return this;
        }
        ...
        protected Builder _appendSubClassMatcher(TypeMatcher matcher) {
            ...
            this._subTypeClassMatchers.add((Object)matcher);
            return this;
        }
    }

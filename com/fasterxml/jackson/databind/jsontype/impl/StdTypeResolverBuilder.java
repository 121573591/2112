...
implements TypeResolverBuilder<StdTypeResolverBuilder> {
    ...
    protected PolymorphicTypeValidator reportInvalidBaseType(MapperConfig<?> config, JavaType baseType, PolymorphicTypeValidator ptv) {
        throw new IllegalArgumentException(String.format((String)"Configured `PolymorphicTypeValidator` (of type %s) denied resolution of all subtypes of base type %s", (Object[])new Object[]{ClassUtil.classNameOf(ptv), ClassUtil.classNameOf(baseType.getRawClass())}));
    }

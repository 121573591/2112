...
implements Serializable {
    ...
    public String toString() {
        ...
        sb.append("; base-type:").append((Object)this._baseType);
        sb.append("; id-resolver: ").append((Object)this._idResolver);
        sb.append(']');
        return sb.toString();
    }

    protected final JsonDeserializer<Object> _findDeserializer(DeserializationContext ctxt, String typeId) throws IOException {
        JsonDeserializer<Object> deser = (JsonDeserializer<Object>)this._deserializers.get((Object)typeId);
        if (deser == null) {
            ...
            this._deserializers.put((Object)typeId, deser);
        }
        return deser;
    }
    ...
    protected Object _deserializeWithNativeTypeId(JsonParser p, DeserializationContext ctxt, Object typeId) throws IOException {
        ...
        if (typeId == null) {
            ...
            String typeIdStr = typeId instanceof String ? (String)typeId : String.valueOf((Object)typeId);
    ...
    protected JavaType _handleUnknownTypeId(DeserializationContext ctxt, String typeId) throws IOException {
        ...
        if (this._property != null) {
            extraDesc = String.format((String)"%s (for POJO property '%s')", (Object[])new Object[]{extraDesc, this._property.getName()});
        }

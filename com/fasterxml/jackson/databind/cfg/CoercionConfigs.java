...
implements Serializable {
    ...
    public CoercionConfigs copy() {
        ...
        if (this._perClassCoercions == null) {
            ...
            for (Map.Entry entry : this._perClassCoercions.entrySet()) {
                newPerClass.put(entry.getKey(), (Object)((MutableCoercionConfig)entry.getValue()).copy());
            }
        }
        return new CoercionConfigs(this._defaultAction, this._defaultCoercions.copy(), newPerType, (Map<Class<?>, MutableCoercionConfig>)newPerClass);
    }
    ...
    public MutableCoercionConfig findOrCreateCoercion(Class<?> type) {
        ...
        if ((config = (MutableCoercionConfig)this._perClassCoercions.get(type)) == null) {
            config = new MutableCoercionConfig();
            this._perClassCoercions.put(type, (Object)config);
        }
        return config;
    }
    ...
    public CoercionAction findCoercion(DeserializationConfig config, LogicalType targetType, Class<?> targetClass, CoercionInputShape inputShape) {
        ...
        if (this._perClassCoercions != null && targetClass != null && (cc = (MutableCoercionConfig)this._perClassCoercions.get(targetClass)) != null && (act = cc.findAction(inputShape)) != null) {
            return act;
        }
    ...
    public CoercionAction findCoercionFromBlankString(DeserializationConfig config, LogicalType targetType, Class<?> targetClass, CoercionAction actionIfBlankNotAllowed) {
        ...
        if (this._perClassCoercions != null && targetClass != null && (cc = (MutableCoercionConfig)this._perClassCoercions.get(targetClass)) != null) {
        ...
        if (Boolean.FALSE.equals((Object)acceptBlankAsEmpty)) {

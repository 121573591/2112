...
public abstract class DatabindContext {
    ...
    public JavaType resolveSubType(JavaType baseType, String subClassName) throws JsonMappingException {
        if (subClassName.indexOf(60) > 0) {
            ...
            try {
                ...
                throw this.invalidTypeIdException(baseType, subClassName, String.format((String)"problem: (%s) %s", (Object[])new Object[]{e.getClass().getName(), ClassUtil.exceptionMessage(e)}));
            }
    ...
    public JavaType resolveAndValidateSubType(JavaType baseType, String subClass, PolymorphicTypeValidator ptv) throws JsonMappingException {
        ...
        try {
            ...
            throw this.invalidTypeIdException(baseType, subClass, String.format((String)"problem: (%s) %s", (Object[])new Object[]{e.getClass().getName(), ClassUtil.exceptionMessage(e)}));
        }
        if (!baseType.isTypeOrSuperTypeOf(cls)) {
    ...
    public <T> T reportBadDefinition(Class<?> type, String msg) throws JsonMappingException {
        return this.reportBadDefinition(this.constructType((Type)type), msg);
    }

    protected final String _format(String msg, Object ... msgArgs) {
        if (msgArgs.length > 0) {
            return String.format((String)msg, (Object[])msgArgs);
        }
        return msg;
    }
    ...
    protected String _quotedString(String desc) {
        ...
        return String.format((String)"\"%s\"", (Object[])new Object[]{this._truncate(desc)});
    }

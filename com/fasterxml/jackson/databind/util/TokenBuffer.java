...
extends JsonGenerator {
        ...
        while (true) {
            ...
            switch (t) {
                ...
                case VALUE_NUMBER_FLOAT: {
                    ...
                    this._reportError(String.format((String)"Unrecognized value type for VALUE_NUMBER_FLOAT: %s, cannot serialize", (Object[])new Object[]{n.getClass().getName()}));
                    break;
                }
                case VALUE_TRUE: {
    ...
    public String toString() {
        ...
        while (true) {
            try {
                ...
                throw new IllegalStateException((Throwable)ioe);
            }
            ++count;
        }
        if (count >= 100) {
    ...
    private final void _appendNativeIds(StringBuilder sb) {
        ...
        if (objectId != null) {
            sb.append("[objectId=").append(String.valueOf((Object)objectId)).append(']');
        }
        if ((typeId = this._last.findTypeId(this._appendAt - 1)) != null) {
            sb.append("[typeId=").append(String.valueOf((Object)typeId)).append(']');
        }
    }
    ...
    public void writeString(Reader reader, int len) throws IOException {
        ...
        for (toRead = len >= 0 ? len : Integer.MAX_VALUE; toRead > 0 && (numRead = reader.read(buf, 0, toReadNow = Math.min((int)toRead, (int)buf.length))) > 0; toRead -= numRead) {
    ...
    public void writeNumber(float f) throws IOException {
        this._appendValue(JsonToken.VALUE_NUMBER_FLOAT, Float.valueOf((float)f));
    }
    ...
    public void writeBinary(Base64Variant b64variant, byte[] data, int offset, int len) throws IOException {
        ...
        System.arraycopy((Object)data, (int)offset, (Object)copy, (int)0, (int)len);
    ...
    protected static final class Segment {
        ...
        private final void assignNativeIds(int index, Object objectId, Object typeId) {
            ...
            if (objectId != null) {
                this._nativeIds.put((Object)this._objectIdIndex(index), objectId);
            }
            if (typeId != null) {
                this._nativeIds.put((Object)this._typeIdIndex(index), typeId);
            }
        }

        Object findObjectId(int index) {
            return this._nativeIds == null ? null : this._nativeIds.get((Object)this._objectIdIndex(index));
        }

        Object findTypeId(int index) {
            return this._nativeIds == null ? null : this._nativeIds.get((Object)this._typeIdIndex(index));
        }
        ...
        static {
            ...
            System.arraycopy((Object)t, (int)1, (Object)TOKEN_TYPES_BY_INDEX, (int)1, (int)Math.min((int)15, (int)(t.length - 1)));
        }
    }
    ...
    extends ParserMinimalBase {
        ...
        public BigInteger getBigIntegerValue() throws IOException {
            ...
            return BigInteger.valueOf((long)n.longValue());
        }
        ...
        public BigDecimal getDecimalValue() throws IOException {
            ...
            if (n instanceof Long) {
                return BigDecimal.valueOf((long)n.longValue());
            }
            if (n instanceof BigInteger) {

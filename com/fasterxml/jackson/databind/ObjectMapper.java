...
Serializable {
    ...
    protected ObjectMapper(ObjectMapper src, JsonFactory factory2) {
        ...
        this._registeredModuleTypes = reg == null ? null : new LinkedHashSet(reg);
    }
    ...
    private static <T> ServiceLoader<T> secureGetServiceLoader(final Class<T> clazz, final ClassLoader classLoader) {
        ...
        if (sm == null) {
            return classLoader == null ? ServiceLoader.load(clazz) : ServiceLoader.load(clazz, (ClassLoader)classLoader);
        }
        return (ServiceLoader)AccessController.doPrivileged((PrivilegedAction)new PrivilegedAction<ServiceLoader<T>>(){

            public ServiceLoader<T> run() {
                return classLoader == null ? ServiceLoader.load((Class)clazz) : ServiceLoader.load((Class)clazz, (ClassLoader)classLoader);
            }
        });
    }

    public ObjectMapper findAndRegisterModules() {
        return this.registerModules((Iterable<? extends Module>)ObjectMapper.findModules());
    }
    ...
    public <T> T readValue(JsonParser p, Class<T> valueType) throws IOException, StreamReadException, DatabindException {
        ...
        return (T)this._readValue(this.getDeserializationConfig(), p, this._typeFactory.constructType((Type)valueType));
    }
    ...
    public <T> T readValue(File src, Class<T> valueType) throws IOException, StreamReadException, DatabindException {
        this._assertNotNull("src", src);
        return (T)this._readMapAndClose(this._jsonFactory.createParser(src), this._typeFactory.constructType((Type)valueType));
    }
    ...
    public <T> T readValue(byte[] src, int offset, int len, Class<T> valueType) throws IOException, StreamReadException, DatabindException {
        this._assertNotNull("src", src);
        return (T)this._readMapAndClose(this._jsonFactory.createParser(src, offset, len), this._typeFactory.constructType((Type)valueType));
    }
    ...
    public ObjectWriter writerFor(Class<?> rootType) {
        return this._newWriter(this.getSerializationConfig(), rootType == null ? null : this._typeFactory.constructType((Type)rootType), null);
    }
    ...
    public ObjectReader reader(Class<?> type) {
        return this._newReader(this.getDeserializationConfig(), this._typeFactory.constructType((Type)type), null, null, this._injectableValues);
    }
    ...
    public <T> T convertValue(Object fromValue, Class<T> toValueType) throws IllegalArgumentException {
        return (T)this._convert(fromValue, this._typeFactory.constructType((Type)toValueType));
    }
    ...
    protected JsonDeserializer<Object> _findRootDeserializer(DeserializationContext ctxt, JavaType valueType) throws DatabindException {
        JsonDeserializer<Object> deser = (JsonDeserializer<Object>)this._rootDeserializers.get((Object)valueType);
        if (deser != null) {
            return deser;
        }
        ...
        this._rootDeserializers.put((Object)valueType, deser);
        return deser;
    }
    ...
    protected final void _assertNotNull(String paramName, Object src) {
        if (src == null) {
            throw new IllegalArgumentException(String.format((String)"argument \"%s\" is null", (Object[])new Object[]{paramName}));
        }
    }

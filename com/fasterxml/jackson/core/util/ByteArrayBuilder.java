...
extends OutputStream {
    ...
    public byte[] toByteArray() {
        ...
        for (byte[] block : this._pastBlocks) {
            ...
            System.arraycopy((Object)block, (int)0, (Object)result, (int)offset, (int)len);
            offset += len;
        }
        System.arraycopy((Object)this._currBlock, (int)0, (Object)result, (int)offset, (int)this._currBlockPtr);
    ...
    public void write(byte[] b, int off, int len) {
        while (true) {
            int max;
            int toCopy;
            if ((toCopy = Math.min((int)(max = this._currBlock.length - this._currBlockPtr), (int)len)) > 0) {
                System.arraycopy((Object)b, (int)off, (Object)this._currBlock, (int)this._currBlockPtr, (int)toCopy);
                off += toCopy;
    ...
    private void _allocMore() {
        ...
        int newSize = Math.max((int)(this._pastLen >> 1), (int)1000);
        if (newSize > 131072) {
            newSize = 131072;
        }

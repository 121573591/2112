...
extends ParserBase {
    ...
    private final boolean _isNextTokenNameMaybe(int i, SerializableString str) throws IOException {
        ...
        String n = this._parseName(i);
        this._parsingContext.setCurrentName(n);
        boolean match = n.equals((Object)str.getValue());
        this._currToken = JsonToken.FIELD_NAME;
        i = this._skipColon();
        this._updateLocation();
        if (i == 34) {
    ...
    protected JsonToken _parseUnsignedNumber(int c) throws IOException {
        ...
        int intLen = 1;
        int outPtr = 1;
        int end = Math.min((int)this._inputEnd, (int)(this._inputPtr + outBuf.length - 1));
        while (true) {
    ...
    private final JsonToken _parseSignedNumber(boolean negative) throws IOException {
        ...
        outBuf[outPtr++] = (char)c;
        int intLen = 1;
        int end = Math.min((int)this._inputEnd, (int)(this._inputPtr + outBuf.length - outPtr));
        while (true) {
            if (this._inputPtr >= end) {
    ...
    protected void _finishString() throws IOException {
        ...
        char[] outBuf = this._textBuffer.emptyAndGetCurrentSegment();
        int[] codes = _icUTF8;
        int max = Math.min((int)this._inputEnd, (int)(ptr + outBuf.length));
    ...
    private final void _finishString2(char[] outBuf, int outPtr) throws IOException {
        ...
        while (true) {
            ...
            block15: {
                ...
                int max = Math.min((int)this._inputEnd, (int)(ptr + (outBuf.length - outPtr)));
                while (ptr < max) {
    ...
    protected void _reportInvalidToken(String matchedPart, String msg) throws IOException {
        ...
        while ((this._inputPtr < this._inputEnd || this._loadMore()) && Character.isJavaIdentifierPart((char)(c = (char)this._decodeCharForError(i = this._inputBuffer[this._inputPtr++])))) {
            sb.append(c);
    ...
    protected void _reportInvalidInitial(int mask) throws JsonParseException {
        this._reportError("Invalid UTF-8 start byte 0x" + Integer.toHexString((int)mask));
    }

    protected void _reportInvalidOther(int mask) throws JsonParseException {
        this._reportError("Invalid UTF-8 middle byte 0x" + Integer.toHexString((int)mask));
    }

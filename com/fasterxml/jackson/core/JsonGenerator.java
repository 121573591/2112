...
Versioned {
    ...
    public void setSchema(FormatSchema schema) {
        throw new UnsupportedOperationException(String.format((String)"Generator of type %s does not support schema of type '%s'", (Object[])new Object[]{this.getClass().getName(), schema.getSchemaType()}));
    }
    ...
    public void writeFieldId(long id) throws IOException {
        this.writeFieldName(Long.toString((long)id));
    }
    ...
    public WritableTypeId writeTypePrefix(WritableTypeId typeIdDef) throws IOException {
        ...
        if (this.canWriteTypeId()) {
            ...
            String idStr = id instanceof String ? (String)id : String.valueOf((Object)id);
    ...
    protected final void _verifyOffsets(int arrayLength, int offset, int length) {
        if (offset < 0 || offset + length > arrayLength) {
            throw new IllegalArgumentException(String.format((String)"invalid argument(s) (offset=%d, length=%d) for input array of %d element", (Object[])new Object[]{offset, length, arrayLength}));
        }
    }

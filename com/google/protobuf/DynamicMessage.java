    ...
    extends AbstractMessage.Builder<Builder> {
        ...
        public DynamicMessage build() {
            if (!this.isInitialized()) {
                throw Builder.newUninitializedMessageException(new DynamicMessage(this.type, this.fields.build(), (Descriptors.FieldDescriptor[])Arrays.copyOf((Object[])this.oneofCases, (int)this.oneofCases.length), this.unknownFields));
            }
        ...
        private DynamicMessage buildParsed() throws InvalidProtocolBufferException {
            if (!this.isInitialized()) {
                throw Builder.newUninitializedMessageException(new DynamicMessage(this.type, this.fields.build(), (Descriptors.FieldDescriptor[])Arrays.copyOf((Object[])this.oneofCases, (int)this.oneofCases.length), this.unknownFields)).asInvalidProtocolBufferException();
            }
            return this.buildPartial();
        }
        ...
        public DynamicMessage buildPartial() {
            ...
            DynamicMessage result = new DynamicMessage(this.type, this.fields.buildPartial(), (Descriptors.FieldDescriptor[])Arrays.copyOf((Object[])this.oneofCases, (int)this.oneofCases.length), this.unknownFields);
            return result;
        }
        ...
        public Builder clone() {
            ...
            System.arraycopy((Object)this.oneofCases, (int)0, (Object)result.oneofCases, (int)0, (int)this.oneofCases.length);
            return result;
        }
        ...
        private static Message.Builder toMessageBuilder(Object o) {
            ...
            throw new IllegalArgumentException(String.format((String)"Cannot convert %s to Message.Builder", (Object[])new Object[]{o.getClass()}));
        }
    }
}

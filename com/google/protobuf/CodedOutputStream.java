...
extends ByteOutput {
    private static final Logger logger = Logger.getLogger((String)CodedOutputStream.class.getName());
    ...
    public final void writeFloat(int fieldNumber, float value) throws IOException {
        this.writeFixed32(fieldNumber, Float.floatToRawIntBits((float)value));
    }

    public final void writeDouble(int fieldNumber, double value) throws IOException {
        this.writeFixed64(fieldNumber, Double.doubleToRawLongBits((double)value));
    }
    ...
    public final void writeFloatNoTag(float value) throws IOException {
        this.writeFixed32NoTag(Float.floatToRawIntBits((float)value));
    }

    public final void writeDoubleNoTag(double value) throws IOException {
        this.writeFixed64NoTag(Double.doubleToRawLongBits((double)value));
    }
    ...
    final void inefficientWriteStringNoTag(String value, Utf8.UnpairedSurrogateException cause) throws IOException {
        logger.log(Level.WARNING, "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable)((Object)cause));
        byte[] bytes = value.getBytes(Internal.UTF_8);
        try {
    ...
    extends AbstractBufferedEncoder {
        ...
        public void write(byte[] value, int offset, int length) throws IOException {
            if (this.limit - this.position >= length) {
                System.arraycopy((Object)value, (int)offset, (Object)this.buffer, (int)this.position, (int)length);
                this.position += length;
                this.totalBytesWritten += length;
            } else {
                int bytesWritten = this.limit - this.position;
                System.arraycopy((Object)value, (int)offset, (Object)this.buffer, (int)this.position, (int)bytesWritten);
                offset += bytesWritten;
                this.position = this.limit;
                this.totalBytesWritten += bytesWritten;
                this.doFlush();
                if ((length -= bytesWritten) <= this.limit) {
                    System.arraycopy((Object)value, (int)offset, (Object)this.buffer, (int)0, (int)length);
                    this.position = length;
                } else {
    ...
    extends CodedOutputStream {
        ...
        AbstractBufferedEncoder(int bufferSize) {
            ...
            this.buffer = new byte[Math.max((int)bufferSize, (int)20)];
    ...
    extends CodedOutputStream {
        ...
        public void write(byte value) throws IOException {
            if (this.position >= this.limit) {
                throw new OutOfSpaceException(String.format((String)"Pos: %d, limit: %d, len: %d", (Object[])new Object[]{this.position, this.limit, 1}));
            }
        ...
        public void write(byte[] value, int offset, int length) throws IOException {
            if (value == null || offset < 0 || length < 0 || value.length - length < offset || this.limit - (long)length < this.position) {
                ...
                throw new OutOfSpaceException(String.format((String)"Pos: %d, limit: %d, len: %d", (Object[])new Object[]{this.position, this.limit, length}));
            }
        ...
        public void writeStringNoTag(String value) throws IOException {
            ...
            try {
                ...
                if (minLengthVarIntSize == maxLengthVarIntSize) {
                    ...
                    Java8Compatibility.position((Buffer)this.buffer, stringStart);
        ...
        @Override
        public void flush() {
            Java8Compatibility.position((Buffer)this.originalBuffer, this.bufferPos(this.position));
        }
        ...
        private void repositionBuffer(long pos) {
            Java8Compatibility.position((Buffer)this.buffer, this.bufferPos(pos));
        }
    ...
    extends CodedOutputStream {
        ...
        public void writeStringNoTag(String value) throws IOException {
            ...
            try {
                ...
                if (minLengthVarIntSize == maxLengthVarIntSize) {
                    ...
                    Java8Compatibility.position((Buffer)this.buffer, startOfBytes);
                    this.encode(value);
                    int endOfBytes = this.buffer.position();
                    Java8Compatibility.position((Buffer)this.buffer, startPos);
                    this.writeUInt32NoTag(endOfBytes - startOfBytes);
                    Java8Compatibility.position((Buffer)this.buffer, endOfBytes);
                } else {
                    int length = Utf8.encodedLength(value);
                    this.writeUInt32NoTag(length);
                    this.encode(value);
        ...
        @Override
        public void flush() {
            Java8Compatibility.position((Buffer)this.originalBuffer, this.buffer.position());
        }
    ...
    extends ArrayEncoder {
        ...
        @Override
        public void flush() {
            Java8Compatibility.position((Buffer)this.byteBuffer, this.initialPosition + this.getTotalBytesWritten());
        }
    }
    ...
    extends CodedOutputStream {
        ...
        ArrayEncoder(byte[] buffer, int offset, int length) {
            ...
            if ((offset | length | buffer.length - (offset + length)) < 0) {
                throw new IllegalArgumentException(String.format((String)"Array range is invalid. Buffer.length=%d, offset=%d, length=%d", (Object[])new Object[]{buffer.length, offset, length}));
            }
            this.buffer = buffer;
            this.offset = offset;
        ...
        public final void write(byte value) throws IOException {
            try {
                ...
                throw new OutOfSpaceException(String.format((String)"Pos: %d, limit: %d, len: %d", (Object[])new Object[]{this.position, this.limit, 1}), e);
            }
        }
        ...
        public final void write(byte[] value, int offset, int length) throws IOException {
            try {
                ...
                throw new OutOfSpaceException(String.format((String)"Pos: %d, limit: %d, len: %d", (Object[])new Object[]{this.position, this.limit, length}), e);
            }
        }

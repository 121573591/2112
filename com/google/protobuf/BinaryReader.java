...
implements Reader {
    ...
    extends BinaryReader {
        ...
        public double readDouble() throws IOException {
            ...
            return Double.longBitsToDouble((long)this.readLittleEndian64());
        }

        @Override
        public float readFloat() throws IOException {
            this.requireWireType(5);
            return Float.intBitsToFloat((int)this.readLittleEndian32());
        }
            ...
            block15: {
                    ...
                    switch (WireFormat.getTagWireType(this.tag)) {
                        case 2: {
                            ...
                            while (this.pos < fieldEndPos) {
                                plist.addDouble(Double.longBitsToDouble((long)this.readLittleEndian64_NoCheck()));
                            }
                            break block15;
                        }
                        case 1: {
                ...
                switch (WireFormat.getTagWireType(this.tag)) {
                    case 2: {
                        ...
                        int fieldEndPos = this.pos + bytes;
                        while (this.pos < fieldEndPos) {
                            target.add((Object)Double.longBitsToDouble((long)this.readLittleEndian64_NoCheck()));
                        }
                        break;
                    }
                    case 1: {
                        ...
                        int nextTag;
                        do {
                            target.add((Object)this.readDouble());
                            if (this.isAtEnd()) {
                                return;
                            }
                            prevPos = this.pos;
            ...
            block15: {
                block14: {
                    ...
                    switch (WireFormat.getTagWireType(this.tag)) {
                        case 2: {
                            ...
                            int fieldEndPos = this.pos + bytes;
                            while (this.pos < fieldEndPos) {
                                plist.addFloat(Float.intBitsToFloat((int)this.readLittleEndian32_NoCheck()));
                            }
                            break block15;
                        }
                        case 5: {
                ...
                switch (WireFormat.getTagWireType(this.tag)) {
                    case 2: {
                        ...
                        int fieldEndPos = this.pos + bytes;
                        while (this.pos < fieldEndPos) {
                            target.add((Object)Float.valueOf((float)Float.intBitsToFloat((int)this.readLittleEndian32_NoCheck())));
                        }
                        break;
                    }
                    case 5: {
                        ...
                        int nextTag;
                        do {
                            target.add((Object)Float.valueOf((float)this.readFloat()));
                            if (this.isAtEnd()) {
                                return;
                            }
                            prevPos = this.pos;
            ...
            if (target instanceof LongArrayList) {
                ...
                switch (WireFormat.getTagWireType(this.tag)) {
                    case 2: {
                        ...
                        int fieldEndPos = this.pos + bytes;
                        while (this.pos < fieldEndPos) {
                            target.add((Object)this.readVarint64());
                        }
                        this.requirePosition(fieldEndPos);
                        break;
                    }
                    case 0: {
                        ...
                        int nextTag;
                        do {
                            target.add((Object)this.readUInt64());
                            if (this.isAtEnd()) {
                                return;
                            }
                            prevPos = this.pos;
            ...
            if (target instanceof LongArrayList) {
                ...
                switch (WireFormat.getTagWireType(this.tag)) {
                    ...
                    case 0: {
                        ...
                        int nextTag;
                        do {
                            target.add((Object)this.readInt64());
                            if (this.isAtEnd()) {
                                return;
                            }
                            prevPos = this.pos;
            ...
            if (target instanceof IntArrayList) {
                ...
                switch (WireFormat.getTagWireType(this.tag)) {
                    case 2: {
                        ...
                        int fieldEndPos = this.pos + bytes;
                        while (this.pos < fieldEndPos) {
                            target.add((Object)this.readVarint32());
                        }
                        this.requirePosition(fieldEndPos);
                        break;
                    }
                    case 0: {
                        ...
                        int nextTag;
                        do {
                            target.add((Object)this.readInt32());
                            if (this.isAtEnd()) {
                                return;
                            }
                            prevPos = this.pos;
            ...
            block15: {
                ...
                switch (WireFormat.getTagWireType(this.tag)) {
                    case 2: {
                        ...
                        int fieldEndPos = this.pos + bytes;
                        while (this.pos < fieldEndPos) {
                            target.add((Object)this.readLittleEndian64_NoCheck());
                        }
                        break;
                    }
                    case 1: {
                        ...
                        int nextTag;
                        do {
                            target.add((Object)this.readFixed64());
                            if (this.isAtEnd()) {
                                return;
                            }
                            prevPos = this.pos;
            ...
            block15: {
                ...
                switch (WireFormat.getTagWireType(this.tag)) {
                    case 2: {
                        ...
                        int fieldEndPos = this.pos + bytes;
                        while (this.pos < fieldEndPos) {
                            target.add((Object)this.readLittleEndian32_NoCheck());
                        }
                        break;
                    }
                    case 5: {
                        ...
                        int nextTag;
                        do {
                            target.add((Object)this.readFixed32());
                            if (this.isAtEnd()) {
                                return;
                            }
                            prevPos = this.pos;
            ...
            if (target instanceof BooleanArrayList) {
                ...
                switch (WireFormat.getTagWireType(this.tag)) {
                    case 2: {
                        ...
                        int fieldEndPos = this.pos + bytes;
                        while (this.pos < fieldEndPos) {
                            target.add((Object)(this.readVarint32() != 0 ? 1 : 0));
                        }
                        this.requirePosition(fieldEndPos);
                        break;
                    }
                    case 0: {
                        ...
                        int nextTag;
                        do {
                            target.add((Object)this.readBool());
                            if (this.isAtEnd()) {
                                return;
                            }
                            prevPos = this.pos;
        ...
        public void readStringListInternal(List<String> target, boolean requireUtf8) throws IOException {
            ...
            do {
                target.add((Object)this.readStringInternal(requireUtf8));
                if (this.isAtEnd()) {
                    return;
                }
                prevPos = this.pos;
        ...
        public void readBytesList(List<ByteString> target) throws IOException {
            ...
            do {
                target.add((Object)this.readBytes());
                if (this.isAtEnd()) {
                    return;
                }
                prevPos = this.pos;
            ...
            block15: {
                ...
                switch (WireFormat.getTagWireType(this.tag)) {
                    ...
                    case 0: {
                        ...
                        int nextTag;
                        do {
                            target.add((Object)this.readUInt32());
                            if (this.isAtEnd()) {
                                return;
                            }
                            prevPos = this.pos;
            ...
            block15: {
                ...
                switch (WireFormat.getTagWireType(this.tag)) {
                    ...
                    case 0: {
                        ...
                        int nextTag;
                        do {
                            target.add((Object)this.readEnum());
                            if (this.isAtEnd()) {
                                return;
                            }
                            prevPos = this.pos;
            ...
            block15: {
                ...
                switch (WireFormat.getTagWireType(this.tag)) {
                    ...
                    case 5: {
                        ...
                        int nextTag;
                        do {
                            target.add((Object)this.readSFixed32());
                            if (this.isAtEnd()) {
                                return;
                            }
                            prevPos = this.pos;
            ...
            block15: {
                ...
                switch (WireFormat.getTagWireType(this.tag)) {
                    ...
                    case 1: {
                        ...
                        int nextTag;
                        do {
                            target.add((Object)this.readSFixed64());
                            if (this.isAtEnd()) {
                                return;
                            }
                            prevPos = this.pos;
            ...
            block15: {
                ...
                switch (WireFormat.getTagWireType(this.tag)) {
                    case 2: {
                        ...
                        int fieldEndPos = this.pos + bytes;
                        while (this.pos < fieldEndPos) {
                            target.add((Object)CodedInputStream.decodeZigZag32(this.readVarint32()));
                        }
                        break;
                    }
                    case 0: {
                        ...
                        int nextTag;
                        do {
                            target.add((Object)this.readSInt32());
                            if (this.isAtEnd()) {
                                return;
                            }
                            prevPos = this.pos;
            ...
            block15: {
                ...
                switch (WireFormat.getTagWireType(this.tag)) {
                    case 2: {
                        ...
                        int fieldEndPos = this.pos + bytes;
                        while (this.pos < fieldEndPos) {
                            target.add((Object)CodedInputStream.decodeZigZag64(this.readVarint64()));
                        }
                        break;
                    }
                    case 0: {
                        ...
                        int nextTag;
                        do {
                            target.add((Object)this.readSInt64());
                            if (this.isAtEnd()) {
                                return;
                            }
                            prevPos = this.pos;

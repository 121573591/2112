...
public final class HttpConversionUtil {
    ...
    public static Http2Headers toHttp2Headers(HttpMessage in, boolean validateHeaders) {
        ...
        if (in instanceof HttpRequest) {
            ...
            if (HttpUtil.isOriginForm(request.uri()) || HttpUtil.isAsteriskForm(request.uri())) {
                ...
                URI requestTargetUri = URI.create((String)request.uri());
    ...
    private static CharSequenceMap<AsciiString> toLowercaseMap(Iterator<? extends CharSequence> valuesIter, int arraySizeHint) {
        ...
        while (valuesIter.hasNext()) {
            AsciiString lowerCased = AsciiString.of((CharSequence)((CharSequence)valuesIter.next())).toLowerCase();
            try {
    ...
    private static void toHttp2HeadersFilterTE(Map.Entry<CharSequence, CharSequence> entry, Http2Headers out) {
        block2: {
            block1: {
                if (AsciiString.indexOf((CharSequence)((CharSequence)entry.getValue()), (char)',', (int)0) != -1) break block1;
                if (!AsciiString.contentEqualsIgnoreCase((CharSequence)AsciiString.trim((CharSequence)((CharSequence)entry.getValue())), (CharSequence)HttpHeaderValues.TRAILERS)) break block2;
                out.add(HttpHeaderNames.TE, HttpHeaderValues.TRAILERS);
                break block2;
            }
            List teValues = StringUtil.unescapeCsvFields((CharSequence)((CharSequence)entry.getValue()));
    ...
    public static void toHttp2Headers(HttpHeaders inHeaders, Http2Headers out) {
        ...
        while (iter.hasNext()) {
            ...
            if (aName.contentEqualsIgnoreCase((CharSequence)HttpHeaderNames.TE)) {
                HttpConversionUtil.toHttp2HeadersFilterTE((Map.Entry<CharSequence, CharSequence>)entry, out);
                continue;
            }
    ...
    private static void setHttp2Scheme(HttpHeaders in, Http2Headers out) {
        HttpConversionUtil.setHttp2Scheme(in, URI.create((String)OUT_OF_MESSAGE_SEQUENCE_PATH), out);
    }

...
extends MessageToMessageCodec<Http2StreamFrame, HttpObject> {
    ...
    protected void decode(ChannelHandlerContext ctx, Http2StreamFrame frame, List<Object> out) throws Exception {
        if (frame instanceof Http2HeadersFrame) {
            ...
            if (dataFrame.isEndStream()) {
                out.add((Object)new DefaultLastHttpContent(dataFrame.content().retain(), this.validateHeaders));
            } else {
                out.add((Object)new DefaultHttpContent(dataFrame.content().retain()));
            }
        }
    }
    ...
    private void encodeLastContent(LastHttpContent last, List<Object> out) {
        ...
        if (last.content().isReadable() || needFiller) {
            out.add((Object)new DefaultHttp2DataFrame(last.content().retain(), last.trailingHeaders().isEmpty()));
        }
        if (!last.trailingHeaders().isEmpty()) {
            ...
            out.add((Object)new DefaultHttp2HeadersFrame(headers, true));
        }
    }
    ...
    protected void encode(ChannelHandlerContext ctx, HttpObject obj, List<Object> out) throws Exception {
        if (obj instanceof HttpResponse) {
            ...
            if (statusClass == HttpStatusClass.INFORMATIONAL && code != 101) {
                if (res instanceof FullHttpResponse) {
                    ...
                    out.add((Object)new DefaultHttp2HeadersFrame(headers, false));
                    return;
                }
        ...
        if (obj instanceof HttpMessage) {
            ...
            out.add((Object)new DefaultHttp2HeadersFrame(headers, noMoreFrames));
        }
        if (obj instanceof LastHttpContent) {
            ...
            out.add((Object)new DefaultHttp2DataFrame(cont.content().retain(), false));
        }
    }

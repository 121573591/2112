...
public class QueryStringDecoder {
    ...
    private static Map<String, List<String>> decodeParams(String s, int from, Charset charset, int paramsLimit, boolean semicolonIsNormalChar) {
        ...
        block6: for (i = from; i < len; ++i) {
            switch (s.charAt(i)) {
                ...
                case '&': {
                    if (QueryStringDecoder.addParam(s, nameStart, valueStart, i, (Map<String, List<String>>)params, charset) && --paramsLimit == 0) {
                        return params;
                    }
                    nameStart = i + 1;
                    break;
        ...
        QueryStringDecoder.addParam(s, nameStart, valueStart, i, (Map<String, List<String>>)params, charset);
        return params;
    }
    ...
    private static boolean addParam(String s, int nameStart, int valueStart, int valueEnd, Map<String, List<String>> params, Charset charset) {
        ...
        List values = (List)params.get((Object)name);
        if (values == null) {

...
implements Comparable<HttpResponseStatus> {
    ...
    public static HttpResponseStatus valueOf(int code, String reasonPhrase) {
        ...
        return responseStatus != null && responseStatus.reasonPhrase().contentEquals((CharSequence)reasonPhrase) ? responseStatus : new HttpResponseStatus(code, reasonPhrase);
    }
    ...
    public static HttpResponseStatus parseLine(String line) {
        try {
            ...
            return space == -1 ? HttpResponseStatus.valueOf(Integer.parseInt((String)line)) : HttpResponseStatus.valueOf(Integer.parseInt((String)line.substring(0, space)), line.substring(space + 1));
        }
        catch (Exception e) {
            throw new IllegalArgumentException("malformed status line: " + line, (Throwable)e);
        }
    }
    ...
    private HttpResponseStatus(int code, String reasonPhrase, boolean bytes) {
        ...
        String codeString = Integer.toString((int)code);

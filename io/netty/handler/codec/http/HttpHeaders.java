...
implements Iterable<Map.Entry<String, String>> {
    ...
    public boolean contains(String name, String value, boolean ignoreCase) {
        ...
        if (ignoreCase) {
            while (valueIterator.hasNext()) {
                if (!((String)valueIterator.next()).equalsIgnoreCase(value)) continue;
                return true;
            }
        } else {
            while (valueIterator.hasNext()) {
                if (!((String)valueIterator.next()).equals((Object)value)) continue;
                return true;
            }
        }
        return false;
    ...
    public boolean containsValue(CharSequence name, CharSequence value, boolean ignoreCase) {
        ...
        while (itr.hasNext()) {
            if (!HttpHeaders.containsCommaSeparatedTrimmed((CharSequence)itr.next(), value, ignoreCase)) continue;
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return HeadersUtils.toString((Class)this.getClass(), this.iteratorCharSequence(), (int)this.size());
    }

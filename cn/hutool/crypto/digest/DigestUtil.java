...
public class DigestUtil {
    ...
    public static String md5Hex16(String data) {
        return DigestUtil.md5Hex16(data, CharsetUtil.CHARSET_UTF_8);
    }
    ...
    public static byte[] sha256(String data) {
        return DigestUtil.sha256(data, "UTF-8");
    }
    ...
    public static String sha256Hex(String data) {
        return DigestUtil.sha256Hex(data, "UTF-8");
    }
    ...
    public static byte[] sha512(String data) {
        return DigestUtil.sha512(data, "UTF-8");
    }
    ...
    public static String sha512Hex(String data) {
        return DigestUtil.sha512Hex(data, "UTF-8");
    }

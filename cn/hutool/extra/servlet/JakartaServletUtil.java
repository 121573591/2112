...
public class JakartaServletUtil {
    ...
    public static Map<String, String> getParamMap(ServletRequest request) {
        ...
        for (Map.Entry entry : JakartaServletUtil.getParams(request).entrySet()) {
    ...
    public static <T> T fillBean(ServletRequest request, T bean, boolean isIgnoreError) {
        return JakartaServletUtil.fillBean(request, bean, CopyOptions.create().setIgnoreError(isIgnoreError));
    }

    public static <T> T toBean(ServletRequest request, Class<T> beanClass, boolean isIgnoreError) {
        return JakartaServletUtil.fillBean(request, ReflectUtil.newInstanceIfPossible(beanClass), isIgnoreError);
    }
    ...
    public static String getHeader(HttpServletRequest request, String name, String charsetName) {
        return JakartaServletUtil.getHeader(request, name, CharsetUtil.charset(charsetName));
    }
    ...
    public static Cookie getCookie(HttpServletRequest httpServletRequest, String name) {
        return (Cookie)JakartaServletUtil.readCookieMap(httpServletRequest).get((Object)name);
    }
    ...
    public static void write(HttpServletResponse response, File file) {
        ...
        try {
            ...
            JakartaServletUtil.write(response, (InputStream)in, contentType, fileName);
        }
        finally {

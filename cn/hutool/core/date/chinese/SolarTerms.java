...
public class SolarTerms {
    ...
    public static int getTerm(int y, int n) {
        ...
        for (int i = 0; i < 6; ++i) {
            _info[i] = Integer.parseInt((String)_table.substring(i * 5, 5 * (i + 1)), (int)16);
        }
    ...
    public static String getTerm(Date date) {
        ...
        return SolarTerms.getTermInternal(dt.year(), dt.month() + 1, dt.dayOfMonth());
    }
    ...
    public static String getTerm(LocalDate date) {
        return SolarTerms.getTermInternal(date.getYear(), date.getMonthValue(), date.getDayOfMonth());
    }

    public static String getTerm(int year, int mouth, int day) {
        return SolarTerms.getTerm(LocalDate.of((int)year, (int)mouth, (int)day));
    }
    ...
    private static String getTermInternal(int year, int mouth, int day) {
        ...
        int termInfo = Integer.parseInt((String)termTable.substring(segment * 5, (segment + 1) * 5), (int)16);
        String termInfoStr = String.valueOf((int)termInfo);
        ...
        int n = segmentOffset = (mouth & 1) == 1 ? 0 : 2;
        if (day == Integer.parseInt((String)segmentTable[segmentOffset])) {
            return TERMS[segment * 4 + segmentOffset];
        }
        if (day == Integer.parseInt((String)segmentTable[segmentOffset + 1])) {

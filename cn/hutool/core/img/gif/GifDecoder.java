...
public class GifDecoder {
    ...
    protected void setPixels() {
        ...
        if (this.lastDispose > 0) {
            ...
            if (this.lastImage != null) {
                ...
                System.arraycopy((Object)prev, (int)0, (Object)dest, (int)0, (int)(this.width * this.height));
                if (this.lastDispose == 2) {
                    Graphics2D g = this.image.createGraphics();
                    Color c = this.transparency ? new Color(0, 0, 0, 0) : new Color(this.lastBgColor);
                    g.setColor(c);
                    g.setComposite((Composite)AlphaComposite.Src);
                    g.fill((Shape)this.lastRect);
                    g.dispose();
                }
            }
        }
    ...
    public int read(String name) {
        ...
        try {
            ...
            if (name.contains((CharSequence)"file:") || name.indexOf(":/") > 0) {
                URL url = new URL(name);
                this.in = new BufferedInputStream(url.openStream());
            } else {
                this.in = new BufferedInputStream(Files.newInputStream((Path)Paths.get((String)name, (String[])new String[0]), (OpenOption[])new OpenOption[0]));
            }
                ...
                case 33: {
                    ...
                    switch (code) {
                        ...
                        case 255: {
                            ...
                            if ("NETSCAPE2.0".contentEquals((CharSequence)app)) {
    ...
    protected void readImage() {
        ...
        this.setPixels();
        this.frames.add((Object)new GifFrame(this.image, this.delay));
        if (this.transparency) {
